                    ...
                    <div class="tab-pane active" id="Employee">
                        <div class="compoenentboxreport">
                            ...
                            <div class="row sortable">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="pb-no" checked="">
                                        <label class="form-check-label" for="pb-no">Purchase Bill NO</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="pb-date" checked="">
                                        <label class="form-check-label" for="pb-date">Purchase Bill Date</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
...
<script src="{{ asset('assets/js/custom/purchase-bill.js') }}"></script>
...
<script>
    window.routes = {
        poReport: @json(route('purchase-bill.report.filter')),
        addScheduler: @json(route('purchase-bill.add.scheduler')),
    };
