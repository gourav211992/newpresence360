                              ...
                              <div class="">
                                 <div class="row align-items-center mb-1">
                                    ...
                                    <div class="col-md-5">
                                       ...
                                       <input type="hidden" name="book_code" id="book_code" value="{{$bom->book_code ?? ''}}">
                                    </div>
                                 </div>
                                <div class="row align-items-center mb-1">
                                    <div class="col-md-3"> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-1">
                                        ...
                                        <input type="hidden" id="head_uom_id" class="form-control" name="uom_id" value="{{$bom->uom?->id}}" />
                                ...
                                <div class="col-md-3 customer_div">
                                    <div class="mb-1">
                                        ...
                                        <input type="hidden" name="customer_id" value="{{$bom?->customer?->id}}" id="customer_id">
                                        <input type="text" id="customer" value="{{$bom?->customer?->customer_code}}" placeholder="Select" class="form-control mw-100 ledgerselecct" name="customer" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-1">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" value="{{$bom->safety_buffer_perc}}" id="safety_buffer_perc" class="form-control mw-100 ledgerselecct" name="safety_buffer_perc"/>
                                    </div>
                                </div>
                                @if($servicesBooks['services'][0]?->alias == \App\Helpers\ConstantHelper::BOM_SERVICE_ALIAS)
                                <div class="col-md-3">
