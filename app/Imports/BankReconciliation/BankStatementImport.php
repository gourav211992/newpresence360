    ...
    */
    ...
    protected function attemptMatch(BankStatement $statement)
    {
        ...
        $match = ItemDetail::join('erp_vouchers','erp_vouchers.id','=','erp_item_details.voucher_id')
                ...
                ->where('erp_item_details.group_id', $statement->group_id)
                ->where('erp_item_details.company_id', $statement->company_id)
                ->where('erp_item_details.organization_id', $statement->organization_id)
