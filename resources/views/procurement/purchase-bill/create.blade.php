...
@endsection
@section('content')
    <form class="ajax-input-form" method="POST" action="{{ route('purchase-bill.store') }}" data-module="pb" data-redirect="/purchase-bills" enctype="multipart/form-data">
...
@section('scripts')
    ...
    <script>
        ...
        function getMrn()
        {
            const ajaxUrl = '{{ route("purchase-bill.get.mrn", ["type" => "create"]) }}';
            var columns = [];
            columns = [
