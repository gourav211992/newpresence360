        ...
        <div class="content-header row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Recruitment
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="content-header-right text-sm-end col-md-6 ">
                <div class="form-group breadcrumb-right">
                    ...
                    <a href="{{ route('recruitment.job-candidates.create') }}" class="btn btn-primary btn-sm mb-sm-0 mb-50"><i
                                ...
                                <table class="datatables-basic table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="cand-inforecsec">
                                                    <div class="">
                                                        ...
                                                        <h5>{{ $candidate->mobile_no }} <a>{{ $candidate->email }}</a></h5>
                                                    </div>

                                                </div>

                                            </td>
                                            <td><a href="{{ url('/').'/'.$candidate->resume_path }}" target="_blank"><img src="{{ asset('img/resume.png') }}" /></a></td>
                                            <td>
                                                @php
                                            ...
                                            <td>{{ $candidate->exp_salary }} LPA</td>
                                            <td>{{ $candidate->location_name }}</td>
                                            <td>
                                                @php
                                                    if($candidate->potential_type == 'low'){
                                                        $className = 'badge-light-danger';
                                                    }elseif($candidate->potential_type == 'medium'){
                                                ...
                                                @endphp
                                                <span
                                                    class="badge rounded-pill {{ $className }} badgeborder-radius">{{ ucfirst($candidate->potential_type) }}</span>
                                            </td>
                                            <td><span
                                                    class="badge rounded-pill {{ $candidate->status == 'active' ? 'badge-light-success' : 'badge-light-danger' }} badgeborder-radius">{{ ucfirst($candidate->status) }}</span>
                                            </td>
                                            <td>
                                                <div class="action-rec">
                                                    <a href="{{ route('recruitment.job-candidates.edit',['id' => $candidate->id]) }}" class="me-50"><i data-feather="edit-3"></i></a>
                                                    <a href="javascript:;" data-url="{{ route('recruitment.job-candidates.destroy',['id' => $candidate->id]) }}" data-request="remove" class="text-danger"><i data-feather="trash-2"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        @empty
                                            <tr><td class="text-danger text-center" colspan="11">No record(s) found.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="mb-1">
                    ...
                    <select class="form-select select2" name="location_id">
                        ...
                        @forelse($locations as $location)
                            <option value="{{ $location->id }}" {{ request('location_id') == $location->id ? 'selected' : '' }}>{{ $location->store_name }}</option>
                        @empty
                        @endforelse
                    </select>
                </div>
