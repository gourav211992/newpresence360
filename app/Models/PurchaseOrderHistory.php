...
class PurchaseOrderHistory extends Model
{
    ...
    {
        return $this->hasMany(PoItemHistory::class, 'purchase_order_id');
    }

    public function po_items_attribute()
    {
        return $this->hasMany(PoItemAttributeHistory::class, 'purchase_order_id');
    }

    public function terms()
    {
        return $this->hasMany(PoTermHistory::class,'purchase_order_id');
    }

    public function po_items_delivery()
    {
        return $this->hasMany(PoItemDeliveryHistory::class,'purchase_order_id');
    }

    public function po_ted()
    {
        return $this->hasMany(PurchaseOrderTedHistory::class,'purchase_order_id');
    }

    public function po_ted_tax()
    {
        return $this->hasMany(PurchaseOrderTedHistory::class,'purchase_order_id')->where('ted_type','Tax');
    }
    ...
    {
        return $this->belongsTo(PoTermHistory::class,'purchase_order_id');
    }
    ...
    {
        return $this->hasOne(PoTermHistory::class,'purchase_order_id');
    }
    ...
    {
        return $this->hasMany(PurchaseOrderTedHistory::class,'purchase_order_id')->where('ted_level', 'H')->where('ted_type','Discount');
    }
    ...
    {
        return $this->hasMany(PurchaseOrderTedHistory::class,'purchase_order_id')->where('ted_type','Expense')->where('ted_level','H');
    }
