                                                    ...
                                                    <tbody id="cogsAccountsTable">
                                                        @if($cogsAccounts->isEmpty())
                                                            <tr data-index="0" data-id="">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control  mw-100 autocomplete category_name" name="stock_accounts[0][category_name]" placeholder="Enter Category">
                                                                        <input type="hidden" name="stock_accounts[0][category_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control  mw-100 autocomplete sub_category_name" name="cogs_accounts[0][sub_category_name]" placeholder="Enter Sub Category">
                                                                        <input type="hidden" name="cogs_accounts[0][sub_category_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 item-select" name="cogs_accounts[0][item_id][]" multiple>
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control  mw-100 autocomplete ledger_name"  name="cogs_accounts[0][ledger_name]"  value="{{ $item->ledger->name ?? '' }}" placeholder="Enter Ledger">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 ledger_group_name" 
                                                                                name="cogs_accounts[0][ledger_group_id]" 
                                                        ...
                                                        @foreach($cogsAccounts as $index => $item)
                                                            <tr data-index="{{ $index }}" data-id="{{ $item->id }}">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control  mw-100 autocomplete category_name" name="gr_acogs_accountsccounts[{{ $index }}][category_name]" value="{{ $item->category->name ?? '' }}" placeholder="Enter Category">
                                                                        <input type="hidden" name="cogs_accounts[{{ $index }}][category_id]" value="{{ $item->category_id ?? '' }}" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control  mw-100 autocomplete sub_category_name" name="cogs_accounts[{{ $index }}][sub_category_name]" value="{{ $item->subCategory->name ?? '' }}" placeholder="Enter Sub Category">
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td>
                                                                   <div class="setup-td-width">
                                                                        <input type="text" class="form-control  mw-100 autocomplete ledger_name"  name="cogs_accounts[{{ $index }}][ledger_name]"  value="{{ $item->ledger->name ?? '' }}" placeholder="Enter Ledger">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 ledger_group_name" 
                                                                                    name="cogs_accounts[{{ $index }}][ledger_group_id]" 
                                                                                    placeholder="Select Ledger Group">
                                                                                @if($item->ledger) 
                                                                                    @php
...
<script>
 document.addEventListener("DOMContentLoaded", function () {
    ...
    if (e.target.closest('.delete-row')) {
        e.preventDefault();
        const row = e.target.closest('tr');
        const cogsAccountId = row.dataset.id;  
        if (cogsAccountId) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    fetch(`/cogs-accounts/${cogsAccountId}`, {  
                        method: 'DELETE',
                        headers: {
...
function addRow(clickedRow) {
    ...
    newRow.innerHTML = `
        ...
        <td>
            <div class="setup-td-width">
                <input type="text" class="form-control  mw-100 autocomplete category_name" name="cogs_accounts[${rowIndex}][category_name]" placeholder="Enter Category">  <!-- Changed to cogs_accounts -->
                <input type="hidden" name="cogs_accounts[${rowIndex}][category_id]" />
            </div>
        </td>
        <td>
            <div class="setup-td-width">
                <input type="text" class="form-control  mw-100 autocomplete sub_category_name" name="cogs_accounts[${rowIndex}][sub_category_name]" placeholder="Enter Sub Category">  <!-- Changed to cogs_accounts -->
                <input type="hidden" name="cogs_accounts[${rowIndex}][sub_category_id]" />  
            </div>
        </td>
        <td>
          <div class="setup-td-width">
                <select class="form-select select2 item-select" name="cogs_accounts[${rowIndex}][item_id][]" multiple> 
                    <option value="">Select Item</option>
                </select>
          </div>
        </td>
        ...
        <td>
          <div class="setup-td-width">
            <input type="text" class="form-control  mw-100 autocomplete ledger_name" name="cogs_accounts[${rowIndex}][ledger_name]" placeholder="Enter Ledger">  <!-- Changed to cogs_accounts -->
            <input type="hidden" name="cogs_accounts[${rowIndex}][ledger_id]" /> 
          <div>
        </td>
        <td>
          <div class="setup-td-width">
            <select class="form-control select2  mw-100 ledger_group_name" name="cogs_accounts[${rowIndex}][ledger_group_id]" placeholder="Select Ledger Group">
            </select>
          <div>
        </td>
        <td>
