...
class ErpTIInvoiceItemHistory extends Model
{
    use HasFactory;

    protected $table = 'erp_ti_invoice_items_history';
    ...
    {
        return $this -> hasMany(ErpTransportInvoiceTedHistory::class, 'invoice_item_id', 'id') -> where('ted_level', 'D') -> where('ted_type', 'Discount');
    }
    public function tax_ted()
    {
        return $this -> hasMany(ErpTransportInvoiceTedHistory::class, 'invoice_item_id', 'id') -> where('ted_level', 'D') -> where('ted_type', 'Tax');
    }
    ...
    {
        return $this -> belongsTo(ErpTransportInvoice::class, 'invoice_id');
    }
    public function dn_cum_invoice()
    {
        return $this -> belongsTo(ErpTransportInvoice::class, 'dn_id');
    }
    public function header()
    {
        return $this -> belongsTo(ErpTransportInvoiceHistory::class, 'sale_invoice_id');
    }

    public function getCgstValueAttribute()
    {
        $tedRecords = ErpTransportInvoiceTedHistory::where('invoice_item_id', $this->id)
        ...
        $tedRecord = ErpTransportInvoiceTedHistory::with(['taxDetail'])
