...
@section('content')
<form id="poEditForm" class="ajax-input-form" action="{{ route('supplier.invoice.update', ['id' => $po->id]) }}" method="POST" data-redirect="/supplier/invoice" enctype="multipart/form-data">
@csrf
				...
				<div class="row">
					...
					<div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                        ...
                        <input type="hidden" name="document_status" value="{{$po->document_status}}" id="document_status">
                            ...
                            @endif
                            @if(!intval(request('amendment') ?? 0) && $po->document_status != \App\Helpers\ConstantHelper::DRAFT && $po->document_status != \App\Helpers\ConstantHelper::SUBMITTED)
                            <a href="{{ route('supplier.invoice.generate-pdf', $po->id) }}" target="_blank" class="btn btn-dark btn-sm mb-50 mb-sm-0 waves-effect waves-float waves-light">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 basic-information">
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <select class="form-select" id="book_id" name="book_id" readonly>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input readonly type="date" class="form-control" value="{{ $po->document_date }}" name="document_date">
                                                </div>
                                            </div>
                                            <div class="row align-items-center mb-1 d-none" id="reference_from">
                                                ...
                                                <div class="col-md-5">
                                                    <input readonly type="text" value="{{$po->reference_number}}" name="reference_number" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center mb-1"> 
                                                ...
                                                <div class="col-md-5 action-button"> 
                                                    <button type="button" class="btn btn-outline-primary btn-sm mb-0 prSelect" {{$po->po_items->count() ? 'disabled' : ''}}><i data-feather="plus-square"></i> {{$reference_from_title}}</button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-1">
                                                        ...
                                                        <select readonly class="form-select" name="currency_id">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-1">
                                                        ...
                                                        <select readonly class="form-select" name="payment_term_id">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="customer-billing-section h-100">
                                                        ...
                                                        <div class="bilnbody">
                                                            <div class="genertedvariables genertedvariablesnone">
                                                                <label class="form-label w-100">Select Billing Address <span class="text-danger">*</span> <a href="javascript:;" class="float-end font-small-2 editAddressBtn d-none" data-type="billing"><i data-feather='edit-3'></i> Edit</a></label>
                                   ...
                                   <div class="col-md-12">
                                       <div class="table-responsive pomrnheadtffotsticky">
                                        ...
                                        <tbody class="mrntableselectexcel">
                                            @include('supplier.si.partials.item-row-edit')
                                        </tbody>
                                        <tfoot>
...
@include('supplier.si.partials.amendment-modal', ['id' => $po->id])
...
{{-- Approval Modal --}}
@include('supplier.si.partials.approve-modal', ['id' => $po->id])
...
<script type="text/javascript">
    var actionUrlTax = '{{route("supplier.invoice.tax.calculation")}}';
</script>
...
function getItemAttribute(itemId, rowCount, selectedAttr, tr){
    ...
    let actionUrl = '{{route("supplier.invoice.item.attr")}}'+'?item_id='+itemId+`&rowCount=${rowCount}&selectedAttr=${selectedAttr}&isPi=${isPi}&po_item_id=${poItemId}`;
    fetch(actionUrl).then(response => {
        return response.json().then(data => {
            if (data.status == 200) {
...
$(document).on('click', '#revokeButton', (e) => {
    let actionUrl = '{{ route("supplier.invoice.revoke.document") }}'+ '?id='+'{{$po->id}}';
    fetch(actionUrl).then(response => {
        return response.json().then(data => {
