	...
	<div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px">
		<div class="modal-content">
			<div class="modal-header">
				<div>
					<h4 class="modal-title fw-bolder text-dark namefont-sizenewmodal" id="prModal">Select Quotation Bom</h4>
				...
				<div class="row">
					...
					<div class="col">
						<div class="mb-1">
							...
							<input type="text" id="customer_po" placeholder="Select" class="form-control mw-100 ledgerselecct ui-autocomplete-input" autocomplete="off" value="">
							<input type = "hidden" id = "customer_id_po"></input>
						</div>
					</div>
					<div class="col">
						<div class="mb-1">
