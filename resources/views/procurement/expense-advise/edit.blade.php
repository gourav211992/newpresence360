@extends('layouts.app')
@section('content')
    <form id="expenseEditForm" data-module="exp" class="ajax-input-form" method="POST" action="{{ route('expense-adv.update', $mrn->id) }}"
        data-redirect="/expense-advice" enctype="multipart/form-data">
        @csrf
                            ...
                            <div class="form-group breadcrumb-right">
                                ...
                                <button type="button" onClick="javascript: history.go(-1)"
                                 ...
                                 @if(!intval(request('amendment') ?? 0) && $mrn->document_status != \App\Helpers\ConstantHelper::DRAFT && $mrn->document_status != \App\Helpers\ConstantHelper::SUBMITTED && $mrn->document_status != \App\Helpers\ConstantHelper::PARTIALLY_APPROVED)
                                    <a href="{{ route('expense-adv.generate-pdf', $mrn->id) }}" target="_blank"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-select header_store_id"
                                                            ...
                                                            <option value=""
                                                                {{ is_null($mrn->store_id) ? 'selected' : '' }}></option>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-1">
                                                                ...
                                                                <input type="text" placeholder="Select"
                                                                    class="form-control mw-100 ledgerselecct"
                                                                ...
                                                                <div class="bilnbody">
                                                                    <div class="genertedvariables genertedvariablesnone">
                                                                        <label class="form-label w-100"
                                                                            style="display: {{ count($mrn->items) > 0 ? 'none' : 'block' }};">
                                                                            Select Shipping Address <span
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        @if ($mrn->cost_center_id !== null)
                                                            <div class="col-md-3" id="cost_center_div"
                                                                style="display:none;">
                                                                <div class="mb-1">
                                                    ...
                                                    <div class="table-responsive pomrnheadtffotsticky">
                                                        <table id="itemTable"
                                                            ...
                                                            <tbody class="mrntableselectexcel">
                                                                @include('procurement.expense-advise.partials.item-row-edit')
                                                            </tbody>
                                                            <tfoot>
                                                                        ...
                                                                        <table class="table border mrnsummarynewsty">
                                                                            ...
                                                                            @if ($mrn->headerDiscount)
                                                                                <tr id="f_header_discount_hidden">
                                                                                    <td><strong>Header Discount</strong>
                                                                                    </td>
                                                                                    <td class="text-end"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <input type="hidden"
                                                                                    name="expense_amount" class="text-end"
                                                                                    id="expense_amount"
                                                                                    value="{{ $mrn->expense_amount }}">
                                                                            </tr>
                                                                            <tr class="voucher-tab-foot">
                                                                                <td class="text-primary"><strong>Total
                                                                                        After Exp.</strong></td>
                                                                                <td>
                                                                                    <div
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-1">
                                                                    ...
                                                                    <input type="file" name="attachment[]"
                                                                        class="form-control"
                                                                        onchange = "addFiles(this,'main_expense_preview')"
                                                                        multiple>
                                                                    <span
    ...
    {{-- Item Locations --}}
    {{-- @include('procurement.expense-advise.partials.item-location-modal') --}}
    <!-- Item Locations Modal End -->

    <!-- Approve/Reject Modal -->
    @include('procurement.expense-advise.partials.approve-modal', ['id' => $mrn->id])
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body alertmsg text-center warning">
                    <i data-feather='alert-circle'></i>
                    <h2>Are you sure?</h2>
                    <p>Are you sure you want to <strong>Amendment</strong> this <strong>Expense</strong>? After Amendment
...
@section('scripts')
    ...
    <script>
        ...
        window.onload = () => {
            ...
            purchaseId = @json($mrn->purchase_order_id);
            if(purchaseId)
            {
            ...
            ['selectedPoIds'].forEach(key => localStorage.removeItem(key));

            const ids = @json($detailsIds);

            if (['po'].includes(currentProcessType)) {
        ...
        function vendorOnChange(vendorId) {
            ...
            let actionUrl = "{{ route('expense-adv.get.address') }}" + '?id=' + vendorId + '&store_id=' + store_id;
            fetch(actionUrl).then(response => {
                return response.json().then(data => {
        ...
        $(document).on('click', '#addNewItemBtn', (e) => {
            ...
            let actionUrl = '{{ route('expense-adv.item.row') }}' + '?count=' + rowsLength + '&component_item=' +
        ...
        $(document).on('click', '#deleteBtn', (e) => {
            ...
            $('.form-check-input:checked').each(function(index, item) {
                ...
                let expense_detail_id = Number($(tr).find('[name*="[expense_detail_id]"]').val()) || 0;
            });
        ...
        function getItemAttribute(itemId, rowCount, selectedAttr, tr) {
            ...
            let actionUrl = '{{ route('expense-adv.item.attr') }}' + '?item_id=' + itemId + '&expense_detail_id=' +
        ...
        $(document).on('click', '.editAddressBtn', (e) => {
            ...
            let actionUrl =
                `{{ route('expense-adv.edit.address') }}?type=${addressType}&vendor_id=${vendorId}&address_id=${addressId}&onChange=${onChange}`;
            fetch(actionUrl)
        ...
        function onPostVoucherOpen(type = "not_posted") {
            // resetPostVoucher();
            const apiURL = "{{ route('expense-adv.posting.get') }}";
            $.ajax({
        ...
        function postVoucher(element) {
            ...
            const postingApiUrl = "{{ route('expense-adv.post') }}"
        ...
        $(document).on('click', '#revokeButton', (e) => {
            let actionUrl = '{{ route('expense-adv.revoke.document') }}' + '?id=' + '{{ $mrn->id }}';
            fetch(actionUrl).then(response => {
                return response.json().then(data => {
        ...
        {
            const ajaxUrl = '{{ route("expense-adv.get.po", ["type" => "edit"]) }}';
            var columns = [];
            columns = [
        ...
        function asnProcess(asnData, moduleProcess) {
            ...
            const baseRoute = '{{ route("expense-adv.process.po-item") }}';
            ...
            fetch(actionUrl)
                ...
                .then(data => {
                    ...
                    const modelType = 'po';
                    const order = data.data.purchaseOrder;

                    vendorOnChange(vendor?.id, modelType, order.id);

                    const getSelectedIdsFn = getSelectedPoIDS;
                    const hiddenFieldName = 'po_item_ids';
                    const localStorageKey = 'selectedPoIds';
