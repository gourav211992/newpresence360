            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-sm-end col-md-7">
                    <div class="form-group d-flex flex-wrap align-items-center justify-content-sm-end mb-sm-0 mb-1"> 
							<a href="{{ route('kaizen.create') }}" class="btn btn-primary box-shadow-2 btn-sm"><i data-feather="upload"></i> Upload Kaizen</a>  
                    </div>
                </div>
            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-dark fw-bolder">
															<h6 class="font-small-2"><span class="text-danger">Problem:</span> Glue and mecl2 mix in the glue gun as defined marking, Conventional method, mixing with wooden stick.</h6>
															<h6 class="font-small-2"><span class="text-success">Counter Measure:</span> Provide a beaker and stirrer for the proper mixing of Glue and mecl2</h6>
														</td> 
                                                        <td><span class="badge rounded-pill badge-light-secondary">Peeling</span></td>
                                                        <td>1</td>
                                                        <td>8</td>
                                                        <td>11</td>
                                                        <td>8</td>
