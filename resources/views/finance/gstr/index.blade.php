                    ...
                    <div class="row">
                        <div class="col-md-12 bg-light border-bottom mb-1 po-reportfileterBox">
                            <div class="row pofilterhead action-button align-items-center">
                                ...
                                <div class="col-md-4 text-sm-end pofilterboxcenter mb-0 d-flex flex-wrap align-items-center justify-content-sm-end"> 
                                    <div class="dropdown">
                                        <button class="btn btn-primary btn-sm mb-50 mb-sm-0 me-50 dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                            <i data-feather="share"></i> Export
                                        </button>
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="{{ url('finance/gstr/json') }}">Export to json</a></li>
                                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#exportJsonModal">Export to csv</a></li>
                                        </ul>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($gstrInvoiceTypes as $key => $item)
                                                @php 
                                                    ...
                                                    $totalTaxAmt += $totalIgst + $totalCgst + $totalSgst + $totalCess;
                                                ...
                                                <tr class="trail-bal-tabl-none">
                                                    ...
                                                    <td>
                                                        <div style="width: 200px">
                                                            <a href="{{ url('/finance/gstr/details').'/'.$item->id }}" class="fw-bolder text-dark">{{ $item->type }}</a>
                                                        </div>
                                                    </td>
                                                    <td><span class="badge rounded-pill badge-light-secondary badgeborder-radius">{{ $item->invoice_count }}</span></td>
                                                    ...
                                                    <td class="text-end">{{ $totalTaxAmt }}</td> 
...
<script>
  document.getElementById('exportCsvForm').addEventListener('submit', function (e) {
      ...
      if (type) {
          const url = `{{ url('finance/gstr/detail/csv') }}/${type}`;
