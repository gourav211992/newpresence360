...
class PendingPaymentExport implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    protected $items;
    protected $service;

    public function __construct($items, CrDrImportExportService $service)
    {
        $this->items = $items;
