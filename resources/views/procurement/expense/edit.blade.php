@extends('layouts.app')
@section('content')
    <form id="expenseEditForm" class="ajax-input-form" method="POST" action="{{ route('expense.update', $mrn->id) }}" data-redirect="/expenses" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                            <div class="form-group breadcrumb-right">
                                ...
                                <a href="{{ route('expense-advice.generate-pdf', $mrn->id) }}" target="_blank" class="btn btn-dark btn-sm mb-50 mb-sm-0 waves-effect waves-float waves-light">
