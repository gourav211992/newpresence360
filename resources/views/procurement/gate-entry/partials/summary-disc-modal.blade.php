                    ...
                    <thead>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" id="new_dis_name_select" placeholder="Select" class="form-control mw-100 ledgerselecct ui-autocomplete-input" autocomplete="off" value="">
                                <input type = "hidden" id = "new_discount_id" />
                                <input type = "hidden" id = "new_dis_name" />
                            </td>
                            <td>
                                ...
                                @foreach($mrn->headerDiscount as $hd_key => $headerDiscount)
                                    <tr class="display_summary_discount_row">
                                        ...
                                        <td>{{$headerDiscount->ted_name ?? ''}}
                                            ...
                                            <input type="hidden" value="{{$headerDiscount->ted_id}}" name="disc_summary[{{$hd_key+1}}][ted_d_id]">
