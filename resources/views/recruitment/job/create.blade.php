...
<div class="app-content content ">
    ...
    <div class="content-wrapper container-xxl p-0">
        <form class="form" role="post-data" method="POST" action="{{ route('recruitment.jobs.store') }}" redirect="{{ route('recruitment.jobs') }}" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                                    ...
                                                    <div class="demo-inline-spacing  customernewsection-form">
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="customColorRadio3"
                                                                ...
                                                                checked value="{{ App\Helpers\CommonHelper::OPEN }}">
                                                        ...
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="customColorRadio4"
                                                                name="status" class="form-check-input" value="{{ App\Helpers\CommonHelper::CLOSED }}">
                                                            <label class="form-check-label fw-bolder"
                                                    ...
                                                    <div class="demo-inline-spacing  customernewsection-form">
                                                        ...
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="customColorRadio9" name="third_party_assessment"
                                                                class="form-check-input" checked="" value="no">
                                                            <label class="form-check-label fw-bolder"
                                            ...
                                            <div class="row align-items-center mb-1" style="display: none" id="assessmentUrl">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="assessment_url" class="form-control"/>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class=" demo-inline-spacing customernewsection-form">
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="Internal" name="publish_for"
                                                                class="form-check-input" checked="" value="internal">
                                                            <label class="form-check-label fw-bolder"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-control select2" id="location_id" name="location_id" >
                                                                            ...
                                                                            @foreach($locations as $location)
                                                                                <option value="{{$location->id}}">{{ ucfirst($location->store_name) }}</option>
                                                                            @endforeach
                                                                        </select> 
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <textarea class="form-control" name="company_detail"></textarea>
                                                                    </div>
                                                                </div>

                                                                {{-- <div class="row align-items-center mb-1">
                                                                    <div class="col-md-4">
                                                                        <label class="form-label">Assessment (if
                                                                            Req.)</label>
                                                                    </div>
                                                                ...
                                                                <div class="row align-items-center mb-1">
                                                                    <div class="col-md-4">
                                                                        <label class="form-label">Questionaries (if
                                                                            Req.)</label>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-select select2" name="working_hour_id" value="{{ old('working_hour_id') }}">
                                                                            <option value="">Select</option>
                                                                    ...
                                                                    <div class="col-md-3 mb-sm-0 mb-1">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input type="checkbox" class="form-check-input"
                                                                                id="colorCheck1" value="1" name="hide_from_candidate" checked>
