            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-sm-end col-md-6 ">
                    <div class="form-group breadcrumb-right">
                        ...
                        <a href="{{ route('recruitment.job-candidates.create') }}"
                            class="btn btn-primary btn-sm mb-sm-0 mb-50"><i data-feather="plus-square"></i> Add New</a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="table-responsive candidates-tables border-0">
                                    ...
                                    <table class="datatables-basic table table-striped">
                                        ...
                                        <tbody>
                                            @forelse($candidates as $candidate)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('/') . '/' . $candidate->resume_path }}"
                                                            target="_blank"><img src="{{ asset('img/resume.png') }}" /></a>
                                                    </td>
                                                    <td>
                                                        @php
                                                    ...
                                                    <td>
                                                        <div class="action-rec">
                                                            <a href="{{ route('recruitment.job-candidates.edit', ['id' => $candidate->id]) }}"
                                                                class="me-50"><i data-feather="edit-3"></i></a>
                                                            <a href="javascript:;"
                                                                data-url="{{ route('recruitment.job-candidates.destroy', ['id' => $candidate->id]) }}"
                                            ...
                                            @empty
                                                <tr>
                                                    <td class="text-danger text-center" colspan="11">No record(s) found.
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
