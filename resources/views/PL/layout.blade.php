...
<style>
    ...
    <!-- BEGIN: Content-->
    <form method="POST" data-completionFunction = "disableHeader" class="ajax-input-form pick-list-form pick-list" action = "{{route('PL.store')}}" data-redirect="{{ $redirect_url }}" id = "pick_list_form" enctype='multipart/form-data'>
                            ...
                            <div class="card">
                                <div class="card-body customernewsection-form" id ="main_so_form">  
                                    <div class="row">
                                        ...
                                        <div class="col-md-8"> 
                                        @if (isset($order))
                                            <input type = "hidden" value = "{{$order -> id}}" name = "pl_header_id"></input>
                                        @endif
