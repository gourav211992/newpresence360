...
class TransactionReportHelper
{
    ...
    const FILTER_ROUTES = [
        ...
        ConstantHelper::SO_SERVICE_ALIAS . '_attribute_grouped' => 'sale.order.report.attribute.grouped',
    ...
    const TABLE_HEADERS = [
        ...
        ConstantHelper::SO_SERVICE_ALIAS . '_attribute_grouped' => self::SO_ATTRIBUTE_GROUPED_TABLE_HEADERS,
