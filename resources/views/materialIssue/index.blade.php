...
<script>
    ...
    var columns = [
        ...
        { data: 'issue_type', name: 'issue_type', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
        { data: 'from_store_code', name: 'from_store_code', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
        ...
        { data: 'requester_type', name: 'requester_type', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
