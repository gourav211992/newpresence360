                                                    ...
                                                    <div class="row align-items-center mb-1" id = "selection_section">
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-2 action-button" id = "lorry_receipt_selection">
                                                             <button type="button" id="select_lorry_button" data-bs-toggle="modal" data-bs-target="#pullPopUpLr" class="btn btn-outline-primary btn-sm mb-0">
                           ...
                           @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12 d-none" id = "general_information_tab">
									<div class="card quation-card">
										<div class="card-header newheader">
											<div>
                                                            ...
                                                            <thead>
                                                             ...
                                                             <tfoot>
                                                                 ...
                                                                 <tr class="totalsubheadpodetail"> 
                                                                    <td colspan="6" id = "item_row_colspan"></td>
