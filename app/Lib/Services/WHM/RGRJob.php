...
class RGRJob
{
    ...
    public function createJob($id, $namespace)
    {
        ...
        $job = ErpWhmJob::firstOrCreate(
            ...
            [
                ...
                'status' => 'pending',
                'trns_type' => RGRConstant::SERVICE_ALIAS,
    ...
    private function generateUniqueQRCodes($header, $job, $namespace, $detail)
    {
        ...
        $this->createUniqueCode($header, $job, $namespace, $detail, $attributes, $qty);
    }

    private function createUniqueCode($header, $job, $namespace, $detail, $attributes, $qty){
        $records = [];
        $uid = null;
        $referenceType = null;
        ...
        for ($i = 0; $i < $qty; $i++) {
            ...
            $records[] = [
                ...
                'job_type' => RGRConstant::SERVICE_ALIAS,
                'trns_type' => RGRConstant::SERVICE_ALIAS,
                'doc_type' => 'receipt',
