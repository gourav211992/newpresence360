                    ...
                    <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td colspan="3" style="font-weight: 700; font-size: 13px; padding-top: 3px;">
                                <b>{{ Str::ucfirst(@$mx?->items?->first()?->toErpStore?->store_name ?? "No address available") }}</b>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td colspan="1" style="padding-top: 3px;">
                                <span style="font-weight: 700; font-size: 13px;">
                                <b>{{ Str::ucfirst(@$mx?->items?->first()?->erpStore?->store_name ?? "Receiving Store Not Required") }}</b>
                                </span>
                            </td>
                        </tr>
                        <tr>
