...
@section('content')
<!-- BEGIN: Content-->
<form method="POST" data-completionFunction="disableHeader" class="ajax-input-form sales_module_form transport_invoice"
   action="{{ route('sale.transporterInvoice.store') }}" data-redirect="{{ $redirect_url }}" id="transport_invoice_form"
            ...
            <div class="form-group breadcrumb-right" id="buttonsDiv">
              ...
              <button type="button" name="action" value="draft" id="save-draft-button"
               ...
               <button type="button" name="action" value="submitted" id="submit-button"
                  onclick="submitForm('submitted');" class="btn btn-primary btn-sm mb-50 mb-sm-0"><i
                           ...
                           <div class="row align-items-center mb-1">
                              ...
                              <div class="col-md-5">
                                 <select class="form-select disable_on_edit"
                                    onChange="getDocNumberByBookId(this);" name="book_id"
                                    id="series_id_input">
                              ...
                              <input type="hidden" name="book_code" id="book_code_input"></input>
                           </div>
                           <div class="row align-items-center mb-1">
                              <div class="col-md-3">
                              ...
                              <div class="col-md-5">
                                 <input type="text" class="form-control disable_on_edit" readonly
                                    id="order_no_input" name="document_no">
                              </div>
                           </div>
                           <div class="row align-items-center mb-1">
                              <div class="col-md-3">
                           ...
                           <div class="row">
                              <div class="col-md-3">
                                 <div class="mb-1">
                                    ...
                                    <input type="text" id="customer_code_input" disabled
                                       ...
                                       autocomplete="off"
                                       onblur="onChangeCustomer('customer_code_input', true)">
                                    <input type="hidden" name="customer_id"
                                       id="customer_id_input"></input>
                                    <input type="hidden" name="customer_code"
                                       id="customer_code_input_hidden"></input>
                                 </div>
                              </div>
                              <div class="col-md-3">
                                 <div class="mb-1">
                              ...
                              <div class="col-md-3">
                                 ...
                                 <input type="hidden" name="payment_terms_code"
                                    id="payment_terms_code_input"></input>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                              ...
                              <div class="customer-billing-section h-100">
                                 ...
                                 <div class="bilnbody">
                                    <div class="genertedvariables genertedvariablesnone">
                                       <div class="mrnaddedd-prim" id="current_billing_address">
                                       </div>
                                       <input type="hidden"
                                          id="current_billing_address_id"></input>
                                       <input type="hidden" id="current_billing_country_id"
                                          name="billing_country_id"></input>
                                       <input type="hidden" id="current_billing_state_id"
                                          name="billing_state_id"></input>
                           ...
                           <!-- <div class="col-md-4">
                              <div class="customer-billing-section">
                                 ...
                                 <div class="bilnbody">
                                    <div class="genertedvariables genertedvariablesnone">
                                       <div class="mrnaddedd-prim" id="current_shipping_address">
                                       </div>
                                       <input type="hidden"
                                          id="current_shipping_address_id"></input>
                                       <input type="hidden" id="current_shipping_country_id"
                                          name="shipping_country_id"></input>
                                       <input type="hidden" id="current_shipping_state_id"
                                          name="shipping_state_id"></input>
                           ...
                           <div class="col-md-6">
                              <div class="customer-billing-section">
                                 ...
                                 <div class="bilnbody">
                                    <div class="genertedvariables genertedvariablesnone">
                                       <div class="mrnaddedd-prim" id="current_pickup_address">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                       ...
                                       <tfoot>
                                          <tr class="totalsubheadpodetail">
                                             ...
                                             <td class="text-end all_tems_total_common"
                                                id="all_items_total_total">00.00</td>
                                             <td></td>
                                          </tr>
                                          <tr valign="top">
