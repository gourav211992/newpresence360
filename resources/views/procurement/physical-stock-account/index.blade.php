...
<div class="app-content content">
    ...
    <div class="content-wrapper container-xxl p-0">
        <form class="ajax-input-form" method="POST" action="{{ route('physical-stock-account.store') }}" data-redirect="{{ url('/physical-stock-accounts') }}" id="physicalStockAccountForm">
            @csrf
                ...
                <div class="row">
                    <div class="content-header-left col-md-6 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Physical Stock Account Setup</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="newheader border-bottom mb-2 pb-25">
                                                <h4 class="card-title text-theme">Physical Stock Account Information</h4>
                                                <p class="card-text">Fill in the details for Physical Stock Account</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border newdesignerptable newdesignpomrnpad">
                                                    ...
                                                    <tbody id="physicalStockAccountsTable">
                                                        @if($physicalStockAccounts->isEmpty())
                                                            <tr data-index="0" data-id="">
                                                                <td>1</td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2" name="physical_stock_accounts[0][company_id]">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2" name="physical_stock_accounts[0][organization_id]">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control mw-100 autocomplete category_name" name="physical_stock_accounts[0][category_name]" placeholder="Enter Category">
                                                                        <input type="hidden" name="physical_stock_accounts[0][category_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="physical_stock_accounts[0][sub_category_name]" placeholder="Enter Sub Category">
                                                                        <input type="hidden" name="physical_stock_accounts[0][sub_category_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 item-select" name="physical_stock_accounts[0][item_id][]" multiple>
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2" name="physical_stock_accounts[0][book_id][]" multiple>
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control mw-100 autocomplete ledger_name" name="physical_stock_accounts[0][ledger_name]" placeholder="Enter Ledger">
                                                                        <input type="hidden" name="physical_stock_accounts[0][ledger_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 ledger_group_name" 
                                                                                name="physical_stock_accounts[0][ledger_group_id]" 
                                                        ...
                                                        @else
                                                            @foreach($physicalStockAccounts as $index => $item)
                                                                <tr data-index="{{ $index }}" data-id="{{ $item->id }}">
                                                                    <td>{{ $index + 1 }}</td>
                                                                    <input type="hidden" name="physical_stock_accounts[{{ $index }}][id]" value="{{ $item->id }}">
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2" name="physical_stock_accounts[{{ $index }}][company_id]">
                                                                                <option value="">Select Company</option>
                                                                                @foreach($companies as $company)
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2" name="physical_stock_accounts[{{ $index }}][organization_id]">
                                                                                <option value="">Select Organization</option>
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <input type="text" class="form-control mw-100 autocomplete category_name" name="physical_stock_accounts[{{ $index }}][category_name]" value="{{ $item->category->name ?? '' }}" placeholder="Enter Category">
                                                                            <input type="hidden" name="physical_stock_accounts[{{ $index }}][category_id]" value="{{ $item->category_id ?? '' }}" />
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="physical_stock_accounts[{{ $index }}][sub_category_name]" value="{{ $item->subCategory->name ?? '' }}" placeholder="Enter Sub Category">
                                                                            <input type="hidden" name="physical_stock_accounts[{{ $index }}][sub_category_id]" value="{{ $item->sub_category_id ?? '' }}" />
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2 item-select" name="physical_stock_accounts[{{ $index }}][item_id][]" multiple>
                                                                                @php 
                                                                                ...
                                                                                @if($subCategoryId && $item->subCategory && $item->subCategory->itemSub->where('status', '!=', 'draft'))
                                                                                    @foreach($item->subCategory->itemSub->where('status', '!=', 'draft') as $itemOption)
                                                                                        @if ((!$organizationId || $itemOption->organization_id == $organizationId) && $itemOption->type === 'Goods')
                                                                                ...
                                                                                @elseif($categoryId && $item->category && $item->category->items->where('status', '!=', 'draft'))
                                                                                    @foreach($item->category->items->where('status', '!=', 'draft') as $itemOption)
                                                                                        @if ((!$organizationId || $itemOption->organization_id == $organizationId) && $itemOption->type === 'Goods')
                                                                                            <option value="{{ $itemOption->id }}" data-item-code="{{ $itemOption->item_code }}" {{ in_array($itemOption->id, $itemIds) ? 'selected' : '' }}>
                                                                                                {{ $itemOption->item_name }} ({{ $itemOption->item_code }})
                                                                                            </option>
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2 book-select" name="physical_stock_accounts[{{ $index }}][book_id][]" multiple>
                                                                                <option value="">Select Book</option>
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <input type="text" class="form-control mw-100 autocomplete ledger_name" name="physical_stock_accounts[{{ $index }}][ledger_name]" value="{{ $item->ledger->name ?? '' }}" placeholder="Enter Ledger">
                                                                            <input type="hidden" name="physical_stock_accounts[{{ $index }}][ledger_id]" value="{{ $item->ledger_id ?? '' }}" />
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2 ledger_group_name" name="physical_stock_accounts[{{ $index }}][ledger_group_id]">
...
<script>
 document.addEventListener("DOMContentLoaded", function () {
    ...
    if (e.target.closest('.delete-row')) {
        e.preventDefault();
        const row = e.target.closest('tr');
        const physicalStockAccountId = row.dataset.id;
        if (physicalStockAccountId) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    fetch(`/physical-stock-accounts/${physicalStockAccountId}`, {
                        method: 'DELETE',
                        headers: {
                    ...
                    .then(response => {
                        if (response.status) {
                            ...
                            Swal.fire('Error!', response.message || 'Could not delete GR account.', 'error');
                        }
                    })
                    .catch(() => {
                        Swal.fire('Error!', 'An error occurred while deleting the GR account.', 'error');
                    });
                }
            });
        } else {
    ...
    function addRow(clickedRow) {
        const tableBody = document.querySelector('#physicalStockAccountsTable');
        ...
        newRow.innerHTML = `
            ...
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2" name="physical_stock_accounts[${rowIndex}][company_id]">
                        <option value="">Select Company</option>
                        @foreach($companies as $company)
                            <option value="{{ $company->id }}">{{ $company->name }}</option>
                        @endforeach
            ...
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2" name="physical_stock_accounts[${rowIndex}][organization_id]">
                        <option value="">Select Organization</option>
                    </select>
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control mw-100 autocomplete category_name" name="physical_stock_accounts[${rowIndex}][category_name]" placeholder="Enter Category">
                    <input type="hidden" name="physical_stock_accounts[${rowIndex}][category_id]" />
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="physical_stock_accounts[${rowIndex}][sub_category_name]" placeholder="Enter Sub Category">
                    <input type="hidden" name="physical_stock_accounts[${rowIndex}][sub_category_id]" />
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2 item-select" name="physical_stock_accounts[${rowIndex}][item_id][]" multiple>
                        <option value="">Select Item</option>
                    </select>
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2" name="physical_stock_accounts[${rowIndex}][book_id][]" multiple>
                        <option value="">Select Book</option>
                    </select>
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control mw-100 autocomplete ledger_name" name="physical_stock_accounts[${rowIndex}][ledger_name]" placeholder="Enter Ledger">
                    <input type="hidden" name="physical_stock_accounts[${rowIndex}][ledger_id]" />
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <select class="form-control select2 mw-100 ledger_group_name" name="physical_stock_accounts[${rowIndex}][ledger_group_id]" placeholder="Select Ledger Group">
                    </select>
                </div>
            </td>
            <td>
    ...
    updateRowIndexes();
    $(document).on('change', '[name^="physical_stock_accounts"][name$="[company_id]"]', function () {
        ...
        if (companyId) {
            $.get(`/physical-stock-accounts/organizations/${companyId}`, function (data) {
    ...
    $(document).on('change', '[name$="[organization_id]"]', function () {
        ...
        $.get(`/physical-stock-accounts/data-by-organization/${organizationId}`, function (data) {
    ...
    $(document).on('focus input', '[name$="[category_name]"]', function () {
        ...
        $.get(`/physical-stock-accounts/categories-by-organization/${organizationId}`, { search: searchTerm }, function (data) {
    ...
    $(document).on('focus input', '[name$="[sub_category_name]"]', function () {
        ...
        $.get(`/physical-stock-accounts/sub-categories-by-category/${categoryId}`, { category_id: categoryId, search: searchTerm }, function (data) {
    ...
    $(document).on('change input', '[name$="[category_id]"]', function () {
        ...
        if (categoryId) {
            $.get(`/physical-stock-accounts/items-and-subcategories-by-category`, { category_id: categoryId }, function (data) {
    ...
    $(document).on('change input', '[name$="[sub_category_id]"]', function () {
        ...
        if (subCategoryId) {
            $.get(`/physical-stock-accounts/items-by-subcategory`, { sub_category_id: subCategoryId }, function (data) {
                data.items.forEach(function (item) {
                    itemSelect.append(`<option value="${item.id}" data-item-code="${item.item_code}">${item.item_name} (${item.item_code})</option>`);
                });
                itemSelect.select2({
    ...
    $(document).on('focus input', '[name$="[ledger_name]"]', function () {
        ...
        $.get(`/physical-stock-accounts/ledgers-by-organization/${organizationId}`, { search: searchTerm }, function (data) {
    ...
    $(document).on('change input', '[name$="[ledger_id]"]', function () {
        ...
        if (selectedLedgerId) {
            $.get('/physical-stock-accounts/ledgers-by-group', {
