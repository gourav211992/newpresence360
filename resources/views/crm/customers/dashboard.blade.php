            ...
            <div class="content-header-right text-sm-end col-md-7">
                <div class="form-group d-flex flex-wrap align-items-center justify-content-sm-end mb-sm-0 mb-1">
                    <div class="btn-group new-btn-group my-1 my-sm-0 me-1">
                        ...
                        <input type="radio" class="btn-check" value="ytd" name="date_filter" {{ Request::get('date_filter') == 'ytd' ? 'checked' : '' }} id="ytd" />
                        <label class="btn btn-outline-primary bg-white" for="ytd">YTD</label>
                    </div>
                    <a href="{{ route('customers.dashboard') }}"><button class="btn btn-warning box-shadow-2 btn-sm me-1"><i data-feather="refresh-cw"></i>
                        Clear</button></a>
                                    ...
                                    <div class="row mb-3 mt-1">
                                        <div class="col-md-3 col-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-8">
                                                    <h2 class="fw-bolder text-primary">{{ $salesSummary['totalAchievementValue'] }}</h2>
                                        ...
                                        <div class="col-md-3 col-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-8">
                                                    <h2 class="fw-bolder text-danger">{{ $salesSummary['totalTargetValue'] }}</h2>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-3">
                                                    <div class="row mt-2 mb-sm-0 mb-1">
                                                        ...
                                                        <div class="col-md-9 col-10">
                                                            <h2 class="fw-bolder text-danger">{{ $topCustomersData['totalSalesValue'] }}</h2>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-4">
                                                    <div class="row mt-sm-2">
                                                        ...
                                                        <div class="col-md-9 col-10">
                                                            <h2 class="fw-bolder text-primary">{{ $bottomCustomersData['bottomCustomerlimit'] }}</h2>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-9 col-10">
                                                            <h2 class="fw-bolder text-success">{{ $bottomCustomersData['totalBottomSales'] }}</h2>
                                                            <p class="card-text" style="line-height: 16px">Sales from
                                                                Bottom Customers</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="row mt-2 mb-sm-0 mb-1">
                                                        ...
                                                        <div class="col-md-9 col-10">
                                                            <h2 class="fw-bolder text-danger">{{ $bottomCustomersData['totalSalesValue'] }}</h2>
                                                            <p class="card-text">Total Sales</p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-12 ">
                                        <table class="table border payrollconfigured customerdataapp">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-dark fw-bolder"><strong>{{ $bottomSalesData->customer->company_name }}</strong></td>
                                                    <td><span
                                                    ...
                                                    <td><span class="badge rounded-pill badge-light-primary me-1">
                                                            @php
                                                                $balanceValue = abs(($bottomSalesData->customerTarget->target_value ?? 0) - ($bottomSalesData->total_sale_value ?? 0));
                                                            @endphp
