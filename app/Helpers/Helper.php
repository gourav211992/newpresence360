...
class Helper
{
    ...
    public static function getFixedAssetRDV($uid = null, $asset_code = null, $sub_asset_code = null, $asset_name = null)
    {
        try {
            ...
            // 1️⃣ Case: UID provided (using id of FixedAssetSub)
            if (!empty($uid)) {
            ...
            // 2️⃣ Case: asset_code + sub_asset_code provided
            ...
            // 3️⃣ Case: only asset_code provided
            ...
            // 4️⃣ Calculate RDV using formula
            $rdvValue = null;
