            ...
            <div class="content-header-right text-sm-end col-md-7">
                <div class="form-group d-flex flex-wrap align-items-center justify-content-sm-end mb-sm-0 mb-1">
                    ...
                    <div class="btn-group new-btn-group my-1 my-sm-0 me-1">
                        ...
                        <input type="radio" class="btn-check" value="ytd" name="date_filter" {{ Request::get('date_filter') == 'ytd' || Request::get('date_filter') == null ? 'checked' : '' }} id="ytd" />
                        <label class="btn btn-outline-primary bg-white" for="ytd">YTD</label>
                    </div>
                    <a href="{{ route('crm.home') }}"><button class="btn btn-primary box-shadow-2 btn-sm me-1"><i data-feather="refresh-cw"></i> Clear</button></a>  
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-sm-6 col-12">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="my-auto">
                                                <h4 class="fw-bolder mb-0">{{ $salesSummary['totalProspectsValue'] }}</h4>
                ...
                <div class="row match-height">
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-header newheader d-flex justify-content-between align-items-start">
                                <div class="header-left">
                                    <h4 class="card-title">View All Closed Business - Prospects Won @if($currencyMaster)(in {{ @$currencyMaster->conversion_type }})@endif</h4> 
                                </div>  
                            </div> 
                            <div class="card-body">
                        ...
                        <div class="card overtimechart"> 
                            <div class="card-header newheader d-flex justify-content-between align-items-start">
                                ...
                                <div class="dropdown d-flex align-items-center">
                                    <p class="mb-0 text-end font-small-2 me-1"><a class="mb-0 text-primary" href="{{ route('notes.index') }}"><i data-feather='eye'></i> View All</a></p>
                            ...
                            <div class="card-body bg-light">
                                <div class="actual-databudgetinfo shadow-none mt-1 rounded-0" style="max-height: 270px; overflow-y: scroll;">
                                        ...
                                        @forelse($topCustomersData['topProspectsSplitByIndustry'] as $data)
                                            <div class="d-flex justify-content-between mt-1 mb-1">
                                                <div class="d-flex align-items-center"> 
                                                    <span class="fw-bold ms-75 me-25">{{ $data['industry'] }}</span> 
                                                </div>
                                                <div>
                                                    <span class="badge rounded-pill badge-light-primary" style="color: {{ $data['color_code'] }} !important;">{{ $data['total_sale_value'] }}</span> 
                                                </div>
                                            </div>
                                        @empty
                                        @endforelse
