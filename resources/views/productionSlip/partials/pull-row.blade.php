@foreach($orders as $index => $order)
    @php
        ...
        $hasInspection = $order?->item?->is_inspection;
        $inspectionChecklistData = $hasInspection == 1 ? $order->item->loadInspectionChecklists() : [];
    @endphp
        ...
        <td>
            <div class="d-flex">
                ...
                <div class="me-50 cursor-pointer item_bundles" onclick = "assignDefaultBundleInfoArray({{$currentOrderIndexVal}}, true)" id = "item_bundles_{{$currentOrderIndexVal}}">    
                    <span data-bs-toggle="tooltip" data-bs-placement="top" title="Details" class="text-warning"><i data-feather="package"></i></span>
                </div>
