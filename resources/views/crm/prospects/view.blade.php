                                ...
                                <div class="row text-center pt-sm-2 pt-1">
                                    ...
                                    <div class="col-md-3 col-6 ps-sm-1 ps-0">
                                        <div class="mail-message">
                                            ...
                                            <select class="discussions-select" name="lead_status" onchange="updateLeadStatus(this.value)">
                        ...
                        <div class="card">
                            <div class="card-header newheader d-flex justify-content-between align-items-start">
                                ...
                                <div class="dropdown d-flex align-items-center">
                                    <div class="newcolortheme cursor-pointer"  data-bs-toggle="modal" data-bs-target="#rescdule" > 
