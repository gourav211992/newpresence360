...
<div class="app-content content ">
    ...
    <div class="content-wrapper container-xxl p-0">
        <form class="form" role="post-data" method="POST" action="{{ url('recruitment/jobs/'.$job->id) }}" redirect="{{ route('recruitment.jobs') }}">
            @csrf
            @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                        <div class="form-group breadcrumb-right">
                            ...
                            <button class="btn btn-primary btn-sm mb-50 mb-sm-0" data-request="ajax-submit" data-target="[role=post-data]"><i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="row align-items-center mb-1">
                                                <div class="col-md-3">
                                                    <label class="form-label">Select Job Title <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-md-5">
                                                    <input type="text" name="job_title_id" value="{{ $job->job_title_name }}" class="form-control" readonly/>
                                                    ...
                                                    <div class="demo-inline-spacing  customernewsection-form">
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="customColorRadio3"
                                                                ...
                                                                {{ $job->status == 'open' ? 'checked' : ''}} value="{{ App\Helpers\CommonHelper::OPEN }}">
                                                        ...
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="customColorRadio4"
                                                                name="status" class="form-check-input" {{ $job->status == 'closed' ? 'checked' : ''}} value="{{ App\Helpers\CommonHelper::CLOSED }}">
                                                            <label class="form-check-label fw-bolder"
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="demo-inline-spacing  customernewsection-form">
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="customColorRadio91" name="third_party_assessment"
                                                                class="form-check-input" value="yes" {{ $job->third_party_assessment == 'yes' ? 'checked' : ''}}>
                                                            <label class="form-check-label fw-bolder"
                                                    ...
                                                    <div class=" demo-inline-spacing customernewsection-form">
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="Internal" name="publish_for"
                                                                class="form-check-input" checked="" value="internal" {{ $job->publish_for == 'internal' ? 'checked' : ''}}>
                                                            <label class="form-check-label fw-bolder"
                                                        ...
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="External" name="publish_for"
                                                                class="form-check-input" value="external" {{ $job->publish_for == 'external' ? 'checked' : ''}}>
                                                            <label class="form-check-label fw-bolder"
                                                        ...
                                                        <div class="form-check form-check-primary mt-25 mb-75">
                                                            <input type="radio" id="Both" name="publish_for"
                                                                class="form-check-input" value="both" {{ $job->publish_for == 'both' ? 'checked' : ''}}>
                                                            <label class="form-check-label fw-bolder" for="Both">For
                                                                Both</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-2">
                                                <div class="tab-content ">
                                                    <div class="tab-pane active" id="Request">
                                                        <h5 class="mt-1 mb-2 text-dark border-bottom pb-75"><strong>Request Info</strong></h5>
                                                        <div class="table-responsive-md">
                                                            <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border">
                                                                ...
                                                                <tbody id="jobRequestTableBody">
                                                                    <tr><td colspan="12" class="text-danger"><strong>Note: Please select job title.</strong></td></tr>
                                                                </tbody>
                                                            </table>
                                                    ...
                                                    <div class="tab-pane active mt-3" id="Pattern">
                                                        <h5 class="mt-1 mb-2 text-dark border-bottom pb-75">
                                                            <strong>Additional Information</strong></h5>

                                                        <div class="row">
                                                            <div class="col-md-6">

                                                                <h5 class="mt-1 mb-2  text-dark"><strong>Job Information</strong></h5>
                                                                ...
                                                                <div class="row align-items-center mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-select select2" name="employement_type">
                                                                            <option value="" {{ $job->employement_type == "" ? 'selected' : "" }}>Select</option>
                                                                            @forelse(App\Helpers\CommonHelper::EMPLOYEMENT_TYPE as $type)
                                                                                <option value="{{ $type }}" {{ $job->employement_type == $type ? 'selected' : "" }}>{{ $type }}</option>
                                                                            @empty
                                                                            @endforelse
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="row align-items-center mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-select select2" name="industry_id">
                                                                            <option value="" {{ $job->industry_id == "" ? 'selected' : "" }}>Select</option>
                                                                            @forelse ($industries as $industry)
                                                                                <option value="{{ $industry->id }}" {{ $job->industry_id == $industry->id ? 'selected' : "" }}>{{ $industry->name }}</option>
                                                                            @empty
                                                                            @endforelse
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-select select2" name="work_mode">
                                                                            <option value="" {{ $job->work_mode == "" ? 'selected' : "" }}>Select</option>
                                                                            @forelse(App\Helpers\CommonHelper::WORK_MODE as $workMode)
                                                                                <option value="{{ $workMode }}" {{ $job->work_mode == $workMode ? 'selected' : "" }}>{{ $workMode }}</option>
                                                                            @empty
                                                                            @endforelse
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-select select2" id="skill" name="skill[]" multiple>
                                                                            <option value="">Select Skill</option>
                                                                            @foreach($skills as $skill)
                                                                                <option value="{{$skill->name}}" {{ in_array($skill->id, $jobSkills) ? 'selected' : '' }}>{{ ucfirst($skill->name) }}</option>
                                                                            @endforeach
                                                                        </select> 
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-control select2" id="location_id" name="location_id" >
                                                                            <option value="" {{ $job->location_id == "" ? 'selected' : "" }}>Select Experience</option>
                                                                            @foreach($locations as $location)
                                                                                <option value="{{ $location->id }}" {{ $job->location_id == $location->id ? 'selected' : "" }}>{{ ucfirst($location->store_name) }}</option>
                                                                            @endforeach
                                                                        </select> 
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <h5 class="mt-1 mb-2  text-dark"><strong>Information for
                                                                        Candidate</strong></h5>
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-select select2" name="education_id" value="{{ old('education_id') }}">
                                                                            <option value="" {{ $job->education_id == "" ? 'selected' : "" }}>Select</option>
                                                                            @forelse ($educations as $education)
                                                                                <option value="{{ $education->id }}" {{ $job->education_id == $education->id ? 'selected' : "" }}>{{ $education->name }}</option>
                                                                            @empty
                                                                            @endforelse
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-md-3 mb-sm-0 mb-1">
                                                                        <input type="number" class="form-control"
                                                                            placeholder="Min" name="work_exp_min" value="{{ $job->work_exp_min }}"/>
                                                                    </div>

                                                                    <div class="col-md-3 mb-sm-0 mb-1">
                                                                        <input type="number" class="form-control"
                                                                            placeholder="Max" name="work_exp_max" value="{{ $job->work_exp_max }}"/>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-select select2" name="working_hour_id">
                                                                            <option value="" {{ $job->working_hour_id == "" ? 'selected' : "" }}>Select</option>
                                                                            @forelse ($workingHours as $workingHour)
                                                                                <option value="{{ $workingHour->id }}" {{ $job->working_hour_id == $workingHour->id ? 'selected' : "" }}>{{ $workingHour->name }}</option>
                                                                            @empty
                                                                            @endforelse
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="row mb-1">
                                                                    <div class="col-md-4">
                                                                        <label class="form-label">Annual Salary (In lacs)<span
                                                                                class="text-danger">*</span></label>
                                                                    </div>

                                                                    <div class="col-md-3 mb-sm-0 mb-1">
                                                                        <input type="number" class="form-control"
                                                                            placeholder="Min" name="annual_salary_min" value="{{ $job->annual_salary_min }}"/>
                                                                        <div
                                                                            class="form-check form-check-primary mt-25 custom-checkbox">
                                                                            <input type="checkbox" class="form-check-input"
                                                                                id="colorCheck1" value="1" name="hide_from_candidate" {{ $job->hide_from_candidate ? 'checked' : "" }}>
                                                                            <label class="form-check-label"
                                                                                for="colorCheck1">Hide for Condidate</label>
                                                                        </div>
                                                                    </div>

                                                                    <div class="col-md-3 mb-sm-0 mb-1">
                                                                        <input type="number" class="form-control"
                                                                            placeholder="Max" name="annual_salary_max" value="{{ $job->annual_salary_max }}"/>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row mb-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select class="form-select select2" name="notice_peroid_id" value="{{ old('notice_peroid_id') }}">
                                                                            <option value="" {{ $job->notice_peroid_id == "" ? 'selected' : "" }}>Select</option>
                                                                            @forelse ($noticePeriods as $noticePeriod)
                                                                                <option value="{{ $noticePeriod->id }}" {{ $job->notice_peroid_id == $noticePeriod->id ? 'selected' : "" }}>{{ $noticePeriod->name }}</option>
                                                                            @empty
                                                                            @endforelse
                                                                        </select>
                                                                    </div>
                                                    ...
                                                    <div class="tab-pane active mt-1" id="Approval">
                                                        ...
                                                        <h5 class="mt-1 mb-2 text-dark border-bottom pb-75"><strong>Interview Allocate
                                                                Panel</strong></h5>
                                                            ...
                                                            <table
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th width="500px">Panelist Name<span
                                                                                class="text-danger">*</span></th>
                                                                        <th width="400px">External Panelist Email-ID</th>
                                                                        <th>Action</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody id="panelist-table-body">
                                                                    @foreach($panelAllocations as $roundId => $items)
                                                                        @php
                                                                            $internalPanelsName = $items->whereNotNull('panel_id')
                                                                                                    ->pluck('panel.name')
                                                                                                    ->filter()
                                                                                                    ->toArray();
                                                                            $externalEmail = $items->whereNotNull('external_email')->pluck('external_email')->first();
                                                                            $roundName = optional($items->first()->round)->name ?? 'N/A';
                                                                        @endphp

                                                                        <tr>
                                                                            <td>{{ $loop->iteration }}</td>

                                                                            <td><span class="badge rounded-pill badge-light-primary badgeborder-radius me-1 mb-1">{{ $roundName }}</span></td>

                                                                            <td>
                                                                                @foreach ($internalPanelsName as $panelName)
                                                                                    <span class="badge rounded-pill badge-light-primary badgeborder-radius">{{ $panelName }}</span>
                                                                                @endforeach
                                                                            </td>

                                                                            <td>
                                                                                <span class="badge rounded-pill badge-light-primary badgeborder-radius">{{ $externalEmail }}</span>
                                                                            </td>

                                                                            <td>
                                                                                <a class="text-danger" href="javascript:;" data-url="{{ route('recruitment.jobs.remove-panel',['id' => $job->id,'roundId' => $roundId, ]) }}" data-request="remove">
                                                                    ...
                                                                    <tr class="panelist-row">
                                                                        <td class="row-index">{{ count($panelAllocations) + 1 }}</td>
                                                                        <td>
                                                                            <select class="form-select mw-100 select2 round" name="data[0][round]" id="round_0">
                                                                        ...
                                                                        <td>
                                                                            <select class="form-select select2 panel_id" multiple  name="data[0][panel_ids][]" id="panel_id_0"></select>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="form-control mw-100 external_email" placeholder="Enter Email-ID" name="data[0][external_email]" id="external_email_0"/>
                                                                        </td>
                                                                        <td class="action-cell">
                                                                            <a href="#" class="text-primary add-row change-to-remove" id="add-more">
