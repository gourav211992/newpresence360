            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        ...
                        @endif
                        <a class="btn btn-dark btn-sm mb-50 mb-sm-0" href="{{ route('transactions.report', ['serviceAlias' => 'pqc']) }}"><i data-feather="bar-chart-2"></i>Report</a>
...
@include('partials.index-filter', ['filterArray' => $filterArray])
@endsection