                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                             <div class="card-body customernewsection-form">
                                <form id="fixed-asset-issue-transfer-form" method="POST" onsubmit="return validateForm()"
                                action="{{ route('finance.fixed-asset.issue-transfer.update',$data->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-5 action-button">
                                                <a type="button" id="modal_asset" data-bs-toggle="modal"
                                                    ...
                                                    class="btn btn-outline-primary btn-sm mb-0" onclick="populateedit()"><i
