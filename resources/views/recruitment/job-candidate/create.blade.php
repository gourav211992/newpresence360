                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <select class="form-select select2" id="skill" name="skill[]"
                                                        ...
                                                        <option value="{{$skill->name}}">{{ ucfirst($skill->name) }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control numberonly" name="work_exp" />
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="demo-inline-spacing">
                                                        ...
                                                        <div class="form-check form-check-primary mt-25">
                                                            <input type="radio" id="customColorRadio4"
                                                                name="status" value="{{ App\Helpers\CommonHelper::INACTIVE }}" class="form-check-input">
                                                            <label class="form-check-label fw-bolder"
                                                    ...
                                                    <div class="demo-inline-spacing">
                                                        ...
                                                        <div class="form-check form-check-primary mt-25">
                                                            <input type="radio" id="No" name="potential_type"
                                                                class="form-check-input" checked="" value="medium">
                                                            <label class="form-check-label fw-bolder"
                                                                for="No">Medium</label>
                                                        </div>
                                                        <div class="form-check form-check-primary mt-25">
                                                            <input type="radio" id="Low" name="potential_type"
                                                                class="form-check-input" value="low">
                                                            <label class="form-check-label fw-bolder"
                                                                for="Low">Low</label>
                                                        </div>
                                                    </div>
