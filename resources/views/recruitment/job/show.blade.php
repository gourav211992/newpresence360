                ...
                <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        ...
                        @if($job->status == App\Helpers\CommonHelper::OPEN && $user->id == $job->created_by)
                        	<a href="{{ route('recruitment.jobs.candidates',['id' => $job->id]) }}" class="btn btn-primary btn-sm mb-50 mb-sm-0"><i data-feather="users"></i> Assign Candidate</a> 
                        @endif
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-7">
                                                <div class="new-applicayion-help-txt pb-25">
                                                    <h4 class="purchase-head text-start">{{ $job->job_title_name
                                                        }}</h4>
                                            ...
                                            <div class="col-md-5 text-end d-sm-flex flex-sm-column align-items-sm-end">
                                                <span
                                                    class="badge rounded-pill fw-bold px-2 py-50 badge-light-success rounded"><i
                                                        data-feather="check-circle"></i> {{ ucfirst($job->status)
                                                    }}</span>
                                            </div>
                                            <div class="col-md-12">
                                                <h6 class="job-descroption-detail">
                                                    @if (Str::length(strip_tags($job->job_description)) > 100)
                                                        ...
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#jobDescModal">...Read More</a>
                                                    @else
                                                        {!! $job->job_description !!}
                                                    @endif
                                                </h6>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-50">
                                                    ...
                                                    <h6 class="fw-bolder text-dark"><span
                                                            ...
                                                            ucfirst($job->publish_for) }}</span>
                                                    </h6>
                                                </div>
                                                <div class="col-md-6 mb-50">
                                                    <label class="form-label">Employeement Type </label>
                                                    <h6 class="fw-bolder text-dark"><span
                                                            class="badge rounded-pill badge-light-primary badgeborder-radius font-small-2">{{
                                                            ucfirst($job->employement_type) }}</span>
                                                    </h6>
                                                </div>
                                                <div class="col-md-6 mb-50">
                                                    <label class="form-label">Industry</label>
                                                    <h6 class="fw-bolder text-dark">{{ $job->industry_name}}</span></h6>
                                                </div>
                                                <div class="col-md-6 mb-50">
                                                ...
                                                <div class="col-md-6 mb-50">
                                                    ...
                                                    <h6 class="fw-bolder text-dark">{{ $job->work_exp_min }} - {{ $job->work_exp_max }} year</h6>
                                                </div>
                                                <div class="col-md-6 mb-50">
                                    ...
                                    <div class="card-body customernewsection-form">
                                        ...
                                        <div
                                            ...
                                            <ul class="timeline ms-50 newdashtimline ">
                                                ...
                                                @php
                                                    if(in_array($log->status, [App\Helpers\CommonHelper::ONHOLD,App\Helpers\CommonHelper::NOT_QUALIFIED])){
                                                        $logClassName = 'badge-light-danger';
                                                        $timeLineClass = 'timeline-point-danger';
                                                    }else if($log->status == App\Helpers\CommonHelper::QUALIFIED){
    ...
    function setStatusModal(status,candidateId) {
        ...
        switch (status) {
            ...
            case 'Not Qualified':
                ...
                modalDescription.textContent = 'Please provide remarks for this candidate being marked as Not Qualified.';
                break;
            case 'On Hold':
