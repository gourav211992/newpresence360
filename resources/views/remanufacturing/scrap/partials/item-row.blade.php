<tr id="scavengingItemsTr_{{ $rowCount }}" data-index="{{ $rowCount }}">
    ...
    {{-- Total Cost --}}
    <td>
        <input type="number" step="any" class="form-control text-end mw-100" name="components[{{ $rowCount }}][total_cost]" value="{{ $item->total_cost ?? '' }}">
    </td>
    ...
    {{-- Remark --}}
    <td>
        <input type="text" class="form-control mw-100" name="components[{{ $rowCount }}][remark]" value="{{ $item->remarks ?? '' }}">
    </td>
</tr>
