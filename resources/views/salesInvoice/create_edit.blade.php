                                                    ...
                                                    <div class="row align-items-center mb-1" id = "selection_section" style = "display:none;">
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-2 action-button" id = "delivery_note_selection">
                                                                <button onclick = "openHeaderPullModal('dnote');" disabled type = "button" id = "select_dn_button" data-bs-toggle="modal" data-bs-target="#pullPopUpDn" class="btn btn-outline-primary btn-sm mb-0"><i data-feather="plus-square"></i>
                                                                 Delivery Note
                                                            </button>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 action-button" id = "lorry_receipt_selection">
                                                             <button type="button" id="select_lorry_button" disabled data-bs-toggle="modal" data-bs-target="#pullPopUpLr" class="btn btn-outline-primary btn-sm mb-0">
		...
		<div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1250px">
			<div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="text-end col-md-3 text-end">
                        <button type="button" class="btn btn-outline-secondary btn-sm" data-bs-dismiss="modal"><i data-feather="x-circle"></i> Cancel</button>
                        <button type="button" class="ml-1 btn btn-primary btn-sm" onclick="processOrder('dnote');" data-bs-dismiss="modal"><i data-feather="check-circle"></i> Process</button>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
				<div class="modal-body">
                     ...
                     <div class="col">
                        ...
                        <div class="col mb-1">
                            <label class="form-label">&nbsp;</label><br />
                            <button onclick="clearFilters('dnote');" type="button" class="btn btn-danger btn-sm"><i
                                    data-feather="trash"></i> Clear</button>
                        </div>
    ...
    function getOrders(type = 'so') {
        ...
        const checkboxColumn = () => ({
            ...
            render: (row, _, __, meta) => {
                ...
                const lrId = row?.id;
                const itemId = row?.id;
                const isEnabled = row?.stock_qty > 0 || row?.check_stock == "no" || ['land-lease', 'plist', 'lr'].includes(type);
