...
class MrnItemLocationHistory extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'erp_mrn_item_location_histories';
    ...
    public function mrnItemLocation()
    {
        return $this->belongsTo(MrnItemLocation::class);
    }
}
