                    ...
                    <div class="tab-pane active" id="Employee">
                        <div class="compoenentboxreport">
                            ...
                            <div class="row sortable">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="pr-no" checked="">
                                        <label class="form-check-label" for="pr-no">Purchase Return NO</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="pr-date" checked="">
                                        <label class="form-check-label" for="pr-date">Purchase Return Date</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="return-type" checked="">
                                        <label class="form-check-label" for="return-type">Quantity Return Type</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
...
<script src="{{ asset('assets/js/custom/purchase-return.js') }}"></script>
...
<script>
    window.routes = {
        poReport: @json(route('purchase-return.report.filter')),
        addScheduler: @json(route('purchase-return.add.scheduler')),
    };
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#mrn_no').on('change', function () {
            const mrnValue = $(this).val();
            filterData.mrnNo = mrnValue; // Set null if no value selected
            updateFilterAndFetch();
        });
            ...
            if (formData.email_to && formData.email_to.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        //         filterModal.hide();
                        //     }
                        // }, 5000); // 10 seconds delay (can adjust this value as needed)
