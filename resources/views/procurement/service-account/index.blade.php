...
<div class="app-content content">
    ...
    <div class="content-wrapper container-xxl p-0">
        <form class="ajax-input-form" method="POST" action="{{ route('service-accounts.store') }}" data-redirect="{{ url('/service-accounts') }}" id="serviceAccountForm">
            @csrf
                ...
                <div class="row">
                    <div class="content-header-left col-md-6 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Service Account Setup</h2>
                                        ...
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border newdesignerptable newdesignpomrnpad">
                                                    ...
                                                    <tbody id="serviceAccountsTable">
                                                        @if($serviceAccounts->isEmpty())
                                                            <tr data-index="0" data-id="">
                                                                <td>1</td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2" name="service_accounts[0][company_id]">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2" name="service_accounts[0][organization_id]">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 item-select" name="service_accounts[0][item_id][]" multiple>
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2" name="service_accounts[0][book_id][]" multiple>
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control autocomplete mw-100 ledger_name" name="service_accounts[0][ledger_name]" placeholder="Enter Ledger">
                                                                        <input type="hidden" name="service_accounts[0][ledger_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 ledger_group_name" 
                                                                                name="service_accounts[0][ledger_group_id]" 
                                                        ...
                                                        @else
                                                            @foreach($serviceAccounts as $index => $item)
                                                                <tr data-index="{{ $index }}" data-id="{{ $item->id }}">
                                                                    <td>{{ $index + 1 }}</td>
                                                                    <input type="hidden" name="service_accounts[{{ $index }}][id]" value="{{ $item->id }}">
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                        <select class="form-select select2 company-select" name="service_accounts[{{ $index }}][company_id]">
                                                                        <option value="">Select Company</option>
                                                                            @foreach($companies as $company)
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 organization-select" name="service_accounts[{{ $index }}][organization_id]" data-row="{{ $index }}">
                                                                            <option value="">Select Organization</option>
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 book-select" name="service_accounts[{{ $index }}][book_id][]" multiple>
                                                                            <option value="">Select Book</option>
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control autocomplete mw-100 ledger_name" name="service_accounts[{{ $index }}][ledger_name]" value="{{ $item->ledger->name ?? '' }}" placeholder="Enter Ledger">
                                                                        <input type="hidden" name="service_accounts[{{ $index }}][ledger_id]" value="{{ $item->ledger_id ?? '' }}" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 ledger_group_name" name="service_accounts[{{ $index }}][ledger_group_id]">
   ...
   function initializeSelect2() {
    ...
    document.querySelector('tbody').addEventListener('click', function (e) {
        ...
        if (e.target.closest('.delete-row')) {
            e.preventDefault();
            const row = e.target.closest('tr');
            const serviceAccountId = row.dataset.id;
            if (serviceAccountId) {
                Swal.fire({
                    title: 'Are you sure?',
                    ...
                    if (result.isConfirmed) {
                        fetch(`/service-accounts/${serviceAccountId}`, {
                            method: 'DELETE',
                            headers: {
                        ...
                        .then(response => {
                            if (response.status) {
                                ...
                                Swal.fire('Error!', response.message || 'Could not delete service account.', 'error');
                            }
                        })
                        .catch(() => {
                            Swal.fire('Error!', 'An error occurred while deleting the service account.', 'error');
                        });
                    }
                });
            } else {
    ...
    function addRow(clickedRow) {
        const tableBody = document.querySelector('#serviceAccountsTable');
        ...
        newRow.innerHTML = `
            ...
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2" name="service_accounts[${rowIndex}][company_id]">
                        <option value="">Select Company</option>
                        @foreach($companies as $company)
                            <option value="{{ $company->id }}">{{ $company->name }}</option>
                        @endforeach
            ...
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2" name="service_accounts[${rowIndex}][organization_id]">
                        <option value="">Select Organization</option>
                    </select>
                </div>
            </td>
            ...
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2 item-select" name="service_accounts[${rowIndex}][item_id][]" multiple>
                        <option value="">Select Item</option>
                    </select>
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2" name="service_accounts[${rowIndex}][book_id][]" multiple>
                        <option value="">Select Book</option>
                    </select>
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control autocomplete mw-100 ledger_name" name="service_accounts[${rowIndex}][ledger_name]" placeholder="Enter Ledger">
                    <input type="hidden" name="service_accounts[${rowIndex}][ledger_id]" />
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <select class="form-control select2 mw-100 ledger_group_name" name="service_accounts[${rowIndex}][ledger_group_id]" placeholder="Select Ledger Group">
                    </select>
                </div>
            </td>
            <td>
    ...
    updateRowIndexes();
    $(document).on('change', '[name^="service_accounts"][name$="[company_id]"]', function () {
        ...
        if (companyId) {
            $.get(`/service-accounts/organizations/${companyId}`, function (data) {
    ...
    $(document).on('change input', '[name$="[ledger_id]"]', function () {
        ...
        if (selectedLedgerId) {
            $.get('/service-accounts/ledgers-by-group', {
