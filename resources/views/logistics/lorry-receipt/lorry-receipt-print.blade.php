...
<body>
    <div style="width:850px; font-size: 11px; font-family:Arial;">

        <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
            <tr>
                <td style="vertical-align: top;">
                    <img src="sheela-logonew.jpeg" height="50px" alt="">
                </td>
                ...
                <td style="text-align: right; font-weight: bold; font-size: 14px; vertical-align: top; width: 260px;">
                </td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
            <tr>
                <td rowspan="2" style="border: 1px solid #000; padding: 3px; width: 35%; vertical-align: top;">
                    <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
                        <tr>
                            <td colspan="3" style="font-weight: 900; font-size: 13px; padding-bottom: 3px;">Buyer Name &
                                Address:
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <span style="font-weight: 700; font-size: 13px;">SHEELA FOAM LTD UNIT-VI (GNA)
                                    (SFL)</span> <br>
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 15px; font-weight: 700;">201306</td>
                        </tr>
                        <tr>
                            <td style="padding-top: 3px;">City:</td>
                            <td style="padding-top: 3px;">GAUTAM BUDH NAGAR</td>
                        </tr>
                        <tr>
                            <td style="padding-top: 3px;">State:</td>
                            <td style="padding-top: 3px;">UTTAR PRADESH</td>
                        </tr>
                        <tr>
                            <td style="padding-top: 3px;">GSTIN NO</td>
                            <td style="padding-top: 3px;">21AAACS0189B1Z0</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 3px;">INDIA</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 3px;">0120-2569291-93</td>
                        </tr>
                ...
                <td rowspan="2"
                    style="border: 1px solid #000; padding: 3px; border-left: none; vertical-align: top; width: 30%;">
                    <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 10px;">BARUT</td>
                        </tr>
                        <tr>
                            <td style="padding-top: 3px;">State:</td>
                            <td style="padding-top: 3px;">UTTAR PRADESH</td>
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 3px;">:256011</td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding-top: 3px;">PHONE:</td>
                            <td style="padding-top: 3px;">9827940696</td>
                        </tr>

                        <tr>
                            <td style="padding-top: 3px;">EMAIL ID:</td>
                            <td style="padding-top: 3px;">kanhaiya@sheelafoam.com</td>
                        </tr>
                ...
                <td style="border: 1px solid #000; padding: 3px; border-left: none; vertical-align: top; width: 35%;">
                    <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>PO No:</td>
                            <td style="font-weight: 900;">GNA / PO / 13</td>
                        </tr>
                        <tr>
                            <td>PO Date:</td>
                            <td style="font-weight: 900;">05-APR-24</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td rowspan="2"
                    ...
                    <div style="width: 267px;">Item Description</div>
                </td>
                <td rowspan="2"
                    style="font-weight: bold; padding: 2px; border: 1px solid #000; border-top: none; border-left: none; background: #80808070; text-align: center;">
                    HSN Code</td>
            ...
            <tr>
                <td
                    ...
                    1.</td>
                <td
                    style="vertical-align: top;  padding: 3px; border: 1px solid #000; border-top: none; border-left: none; border-bottom: none;">
                    HDPE
                    PLAIN*/*600D/*80G/55×45×33.5"
                    HDPE
                    PLAIN*/*600D/*80G/76×37×33.5"
                    Tech Spec. *Type-HDPE(with handles)-
                    Side yellow, ProductPlain,Length=1397mm(-
                    0mm),Width=1143mm(-
                    0mm),Height=851mm(-0mm),Flap
                    Length=1467mm(-0mm),Flap
                    Width=1213mm(-
                    0mm),Denier=600,Gauge=80,Weight=6
                    31g(-6%/+open), Visual-Dirt free,Untorn and ink fastness should be good
                </td>
                <td
            ...
            <tr>
                <td
                    style=" vertical-align: top; padding: 3px; border: 1px solid #000; border-top: none;  text-align: center; ">
                    2.</td>
                <td
                    style="vertical-align: top;  padding: 3px; border: 1px solid #000; border-top: none; border-left: none; ">
                    HDPE
                    PLAIN*/*600D/*80G/55×45×33.5"
                    HDPE
                    PLAIN*/*600D/*80G/76×37×33.5"
                ...
                <td
                    style=" vertical-align: top; padding: 3px; border: 1px solid #000; border-top: none; border-left: none; text-align: center;">
                    39232100</td>
                <td
                    style=" vertical-align: top; padding: 3px; border: 1px solid #000; border-top: none; border-left: none; text-align: center;  text-align: center;">
                    1000.00</td>
                <td
                    style="vertical-align: top; padding: 3px; border: 1px solid #000; border-top: none; border-left: none; text-align: center;">
                    90.3400</td>
        ...
        <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
            <tr>
                <td style="padding: 3px; border: 1px solid #000; width: 50%; border-top: none; vertical-align: top;">
                    <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
                        <tr>
                            <td> Total PO Value (In Words) <br>
                                INR Five Lakh Seventy-Three Thousand Five Hundred Seventy-Four only</td>
                        </tr>
                        <tr>
                            <td style="padding-top: 15px;">Currency: INR</td>
                        </tr>
                        <tr>
                ...
                <td
                    ...
                    <table style="width: 100%; margin-bottom: 0px; margin-top: 10px;" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td style="text-align: right;">196531.02</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: right; padding-top: 3px;">Discount:</td>
                            <td style="text-align: right; padding-top: 3px;"></td>
                        </tr>
                        <tr>
                            <td style="text-align: right; padding-top: 3px;">Taxable Value:</td>
                            <td style="text-align: right; padding-top: 3px;">196531.02</td>
                        </tr>
                        <tr>
                            <td style="text-align: right; padding-top: 3px;">CGST Value:</td>
                            <td style="text-align: right; padding-top: 3px;">35375.60</td>
                        </tr>
                        <tr>
                            <td style="text-align: right; padding-top: 3px;">SGST Value:</td>
                            <td style="text-align: right; padding-top: 3px;">43747.20
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right; padding-top: 3px;">IGST Value:</td>
                            <td style="text-align: right; padding-top: 3px;"></td>
                        </tr>
                        <tr>
                            <td style="text-align: right; padding-top: 3px;">Round Off:</td>
                            <td style="text-align: right; padding-top: 3px;">.40</td>
                        </tr>
                        <tr>
                            <td style="text-align: right; padding-top: 3px;">
                                Total PO Value:
                            </td>
                            <td style="text-align: right; padding-top: 3px;">573574.00</td>
                        </tr>
                    </table>
                </td>
            </tr>
                ...
                <td
                    ...
                    <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 15px;">30.04.2024</td>
                        </tr>
                        <tr>
                            <td style="padding-top: 5px;">Mode of Transport :</td>
                            <td style="padding-top: 5px;">BY ROAD</td>
                        </tr>
                        <tr>
                            <td style="padding-top: 5px;">Payment Terms :</td>
                            <td style="padding-top: 5px;">AFTER 30 DAYS FROM THE DATE OF RECEIPT OF MATERIAL</td>
                        </tr>
                    </table>
            ...
            <td
                ...
                <table style="width: 100%; margin-bottom: 0px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td style="padding-top: 5px;">NEELAM KUMARI</td>
                    </tr>
                    <tr>
                        <td style="padding-top: 5px;">Printed By :</td>
                        <td style="padding-top: 5px;">A2Z DATABASE ADMINISTRATOR</td>
                    </tr>
                </table>
 ...
 Full) / Match Stick is found. This penalty shall multiply with additional Match Boxes. Each lighter shall also
 attract a penalty of Rs. 1500/- (Rupees One Thousand Five Hundred Only).
                </td>
            </tr>
            <tr>
