                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-3 pe-sm-0 mb-1 mb-sm-0">
                                                    <input type="text" name="category_name" class="form-control category-autocomplete" placeholder="Type to search category" value="{{ $item->category->name ?? '' }}">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" name="subcategory_name" class="form-control subcategory-autocomplete" placeholder="Type to search sub-category" value="{{ $item->subCategory->name ?? '' }}">
