...
return new class extends Migration
{
    public function up()
    {
        Schema::create('erp_finance_fixed_asset_registration_history', function (Blueprint $table) {
            $table->id();

            // Additional column for history
            $table->unsignedBigInteger('source_id')->index()->comment('Refers to erp_finance_fixed_asset_registration.id');
    ...
    {
        Schema::dropIfExists('erp_finance_fixed_asset_registration_history');
    }
};
