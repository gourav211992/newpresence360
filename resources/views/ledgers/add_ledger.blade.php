                                                ...
                                                <div class="col-md-5">
                                                    <select class="form-select select2" multiple id="ledger_group_id" name="ledger_group_id[]" required>
                                                        @foreach ($groups as $group)
                                                            <option value="{{ $group->id }}" data-ledgergroup="{{ $group->parent_group_id }}"
                                                ...
                                                <div class="col-md-5">
                                                    <select name="cost_center_id" class="form-select select2">
                                                        ...
                                                        @foreach ($costCenters as $costCenter)
                                                            <option value="{{ $costCenter->id }}" @if(old('cost_center_id') && old('cost_center_id') == $costCenter->id) selected @endif>
												 ...
												 <div class="tab-content pb-1 px-1">
                                                        <div class="tab-pane active" id="UOM">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <select class="form-select" id="tax_type" name="tax_type">
                                                                            ...
                                                                            @foreach(App\Helpers\ConstantHelper::getTaxTypes() as $value => $label)
                                                                                <option value="{{ $value }}" @selected(old('tax_type') == $value)>
                                                                                    {{ $label }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <select class="form-select select2" name="tcs_section" id="tcs_section">
                                                                        ...
                                                                        @foreach(App\Helpers\ConstantHelper::getTcsSections() as $value => $label)
                                                                            <option value="{{ $value }}" @selected(old('tcs_section') == $value)>
                                                                                {{ $label }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="row align-items-center mb-1" id="tcs_percentage_label">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" class="form-control" id="tcs_percentage" name="tcs_percentage" />
                                                                </div>
                                                            </div>
