...
<body>
    <div style="width:700px; font-size: 11px; font-family:Arial;" class="page-break">
        ...
        @if (!empty($allChildBoms))
            <h3
                style=" vertical-align: top; padding:10px 3px; border: 1px solid #000; border: 1px solid #000; background: #80808070; text-align: center;">
                Child Bom Details
            </h3>
            @foreach ($allChildBoms as $bomId)
                {!! \App\Helpers\ItemHelper::setBomPrintTable($bomId) !!}
                <br>
                <br>
            @endforeach
        @endif
