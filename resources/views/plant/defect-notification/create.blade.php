				...
				<div class="row">
					...
					<div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
						<div class="form-group breadcrumb-right">   
                            ...
                            <button type="button" id="save-draft-btn" class="btn btn-outline-primary btn-sm mb-50 mb-sm-0"><i data-feather='save'></i> Save as Draft</button> 
                            <button type="submit" form="defect-notification-form" class="btn btn-primary btn-sm mb-50 mb-sm-0"><i data-feather="check-circle"></i> Submit</button> 
						</div>
					</div>
				</div>
			</div>
            <div class="content-body">
                <form id="defect-notification-form" method="POST" action="{{ route('defect-notification.store') }}" enctype="multipart/form-data">
                    @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-1">
                                                            ...
                                                            <select class="form-select" id="defect_type_id" name="defect_type_id">
													...
													<div class="col-md-3">
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text" id="problem" name="problem" value="" class="form-control"/> 
                                                        </div>
                                                    </div>
													...
													<div class="col-md-12">
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text" name="detailed_oberservation" class="form-control"/>
                                                        </div>
                                                    </div>
                                                 </div>
