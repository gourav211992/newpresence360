                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($supplierSplits->isNotEmpty() && count($supplierSplits) > 2)
                                                    <a href="#" class="read-more" data-bs-toggle="modal" data-bs-target="#supplierSplitsModal" data-splits="{{ json_encode($supplierSplits) }}">
                                                        Read more
                                                    </a>
                                                @endif
                                            </td>
...
@section('modals')
<!-- Modal -->
<div class="modal fade" id="supplierSplitsModal" tabindex="-1" aria-labelledby="supplierSplitsModalLabel" aria-hidden="true">
