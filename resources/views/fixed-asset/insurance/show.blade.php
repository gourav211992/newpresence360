                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('finance.fixed-asset.insurance.index') }}">Home</a>
                                    </li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                             <div class="card-body customernewsection-form">
                                <form id="fixed-asset-insurance-form">
                                <div class="row">
                                    <div class="col-md-12">
...
function showToast(icon, title) {
    ...
    const form = document.getElementById('fixed-asset-insurance-form');
