                        ...
                        <div class="row">
                                ...
                                <div class="customernewsection-form poreportlistview p-1">
                                    ...
                                    <div class="col-md-3">
                                        @if (request()->hasAny(['ledger', 'age0', 'age1', 'age2', 'age3', 'age4']))
                                            <a type="button" href="{{ route('voucher.credit.report') }}"
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive trailbalnewdesfinance po-reportnewdesign gsttabreporttotal">
                                    <table
                                        class="datatables-basic table tableistlastcolumnfixed myrequesttablecbox tabledebreport">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Group</th>
                                                    ...
                                                    <td>
                                                        ...
                                                        @php
                                                          $query = [];
                                                            ...
                                                            $url = route('crdr.report.ledger.details', ['credit', $customer->ledger_id, $customer->ledger_parent_id]);
                                                            if ($query) {
