                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row align-items-center mb-1 exisitng">
                                ...
                                <div class="col-md-5">
                                    <select class="form-select select2" name="customer_code" id="customer_code" onchange="fetchCustomers(this.value)">
                                        <option value="" {{ old('customer_code')=="" ? 'selected' : '' }}>Select</option>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row loandetailview">
                                            ...
                                            <div class="col-md-4 mb-1" id="newProductCategoryDiv" style="display:none">
                                                <label class="form-label">Product Category</label>
                                                <select class="form-select p-50 text-dark select2"
                                                    name="product_category_id" id="product_category_id">
                                                    <option value="" disabled {{ old('product_category_id') ? ''
                                            ...
                                            <div class="col-md-4 mb-1" id="newLeadSourceDiv" style="display:none">
                                                ...
                                                <select class="form-select p-50 text-dark select2"
                                                    ...
                                                    <option value="" disabled {{ old('lead_source_id') ? ''
                                            ...
                                            <div class="col-md-4 mb-1" id="newCurrencyDiv" style="display:none">
                                                ...
                                                <select class="form-select p-50 text-dark select2"
                                                    ...
                                                    <option value="" disabled {{ old('currency_id') ? ''
                                    ...
                                    <div class="m-2 p-2 rounded bg-white customernewsection-form">
                                        ...
                                        <div class="row mb-1">
                                            <div class="col-md-3 lead-contacts">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#leadContacts">Add Contacts</button>
                                            </div>
            ...
            success: function (response) {
                ...
                if (response.status === 200 && response.customers) {
                    ...
                    $.each(optionList, function (index, value) {
                        const selected = value.customer_code === parseInt(selectedValue) ? "selected" : "";
                        options += `<option value="${value.customer_code}" ${selected}>${value.company_name}</option>`;
                    });
    ...
    function fetchLeadContacts(contacts){
        if(contacts.length > 0){
            ...
            $.each(contacts, function(index, contact) {
                ...
                html += '<div class="col-3"><div class="mb-1 form-control">' + contact.contact_name + '</div></div>';
                html += '<div class="col-3"><div class="mb-1 form-control">' + contact.contact_number + '</div></div>';
                html += '<div class="col-3"><div class="mb-1 form-control">' + contact.contact_email + '</div></div>';
                html += '<div class="col-3"><a data-url="{{ url('crm/notes/remove-lead-contacts') }}/'+contact.id+'" data-request="remove-lead-contact"><img src="{{ asset('/app-assets/images/icons/trash.svg') }}"></a></div>';
                html += '</div>';
            });
