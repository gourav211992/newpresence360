...
<div class="app-content content">
    ...
    <form class="form" role="post-data" method="POST" action="{{ route('recruitment.requests.store') }}" redirect="{{ route('recruitment.requests') }}" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                                ...
                                                <div class="demo-inline-spacing">
                                                    <div class="form-check form-check-primary mt-25">
                                                        <input type="radio" id="New" name="job_type" value="new"
                                                            class="form-check-input job_type" checked/>
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="no_of_position" value="{{ old('no_of_position') }}"/>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-select select2" name="education_id" value="{{ old('education_id') }}">
                                                    ...
                                                    @forelse ($eduactions as $eduaction)
                                                        <option value="{{ $eduaction->id }}">{{ $eduaction->name }}</option>
                                                    @empty
                                                    @endforelse
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-control select2" id="work_exp_id" name="work_exp_id" >
                                                    ...
                                                    @foreach($workExperiences as $workExperience)
                                                        <option value="{{$workExperience->id}}">{{ ucfirst($workExperience->name) }}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
                                        </div>
