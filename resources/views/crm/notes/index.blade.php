                                                ...
                                                <div class="mt-2 customernewsection-form seqarch-cleintdiary">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="form-check form-check-primary mb-75">
                                                                <input type="radio" id="customColorRadio1"
                                                                    name="objective" value="{{ $objective->id }}" class="form-check-input"
                                                        ...
                                                        <div class="">
                                                            <div class="form-check form-check-primary mb-75">
                                                                <input type="radio" id="Today" name="daterange"
                                                                    class="form-check-input" value="today" {{ Request::get('daterange') == "today" ? "checked" : "" }}>
                                                                <label class="form-check-label fw-bold"
                                                                    for="Today">Today</label>
                                                            </div>
                                                            <div class="form-check form-check-primary mb-75">
                                                                <input type="radio" id="week" value="this week" name="daterange"
                                                                    class="form-check-input" {{ Request::get('daterange') == "this week" ? "checked" : "" }}>
                                                                <label class="form-check-label fw-bold" for="week">This
                                                                    week</label>
                                                            </div>
                                                            <div class="form-check form-check-primary  mb-75">
                                                                <input type="radio" id="Month" name="daterange"
                                                                value="this month" class="form-check-input" {{ Request::get('daterange') == "this month" ? "checked" : "" }}>
                                                                <label class="form-check-label fw-bold" for="Month">This
                                                                    Month</label>
                                                            </div>
                                                            <div class="form-check form-check-primary  mb-75">
                                                                <input type="radio" id="year" name="daterange" value="this year"
                                                                    class="form-check-input" {{ Request::get('daterange') == "this year" ? "checked" : "" }}>
                                                                <label class="form-check-label fw-bold" for="year">This
                                                                    year</label>
                                                            </div>
                                                            <div class="form-check form-check-primary mt-0">
                                                                <input type="radio" id="custom" name="daterange" value="custom" {{ Request::get('daterange') == "custom" ? "checked" : "" }}
                                                    ...
                                                    <div class="mb-1">
                                                        ...
                                                        <select class="form-select select2" name="customer_id">
                                                            <option value="" {{ Request::get('customer_id') == "" ? 'selected' : '' }}>Select</option>
                                                            @foreach($customers as $customer)
                                                                <option value="{{ $customer->id }}" {{ Request::get('customer_id') == $customer->id ? 'selected' : '' }}>{{ $customer->company_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="lefttask-added">
                                                    <button type="button" id="search-btn" class="btn btn-primary w-45 mb-2" onclick="applyFilter()"><i data-feather="search"></i> Search</button>
                                                    <a href="{{ url('/crm/notes') }}"class="btn btn-outline-secondary  w-50 mb-2">Clear</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card mb-0 bg-light shadow-none rounded-0 overtimechart">
                                        <div
                                            ...
                                            <div class="header-left text-center">
                                                <h4 class="card-title">
                                                    <a href="#" class="me-1" id="previous"><i data-feather="arrow-left-circle"></i></a> 
                                                    <span id="current-date">{{ Request::get('date') ?? date('d-m-Y') }}</span>
                                                    <a href="#" class="ms-1" id="next"><i data-feather="arrow-right-circle"></i></a>
                                                </h4>
                                            </div>
