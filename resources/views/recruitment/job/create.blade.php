...
@section('content')
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            <form class="form" role="post-data" method="POST" action="{{ route('recruitment.jobs.store') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-select select2" name="job_title_id"
                                                            onchange="fetchJobRequests(this.value)">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="date" name="last_apply_date"
                                                            class="form-control" />
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="tab-pane active mt-3" id="Pattern">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-md-3 mb-sm-0 mb-1">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    name="hide_from_candidate" checked>
                                                                    ...
                                                                    <div class="row mb-1">
                                                                        <div class="col-md-4">
                                                                            <label class="form-label">Notification E-Mail
                                                                                <span class="text-danger">*</span></label>
                                                                        </div>
