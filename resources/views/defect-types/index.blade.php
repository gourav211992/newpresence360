            ...
            <div class="row">
                ...
                <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        <button id="submitBtn" class="btn btn-primary btn-sm mb-50 mb-sm-0"><i data-feather="check-circle"></i> Submit</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body customernewsection-form">
                                <div class="newheader border-bottom mb-2 pb-25">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-sm-0 mt-50 text-sm-end">
                                            <button id="deleteRows" class="btn btn-outline-danger btn-sm mb-50 mb-sm-0"><i data-feather="x-circle"></i> Delete</button>
                                            <button id="addRow" class="btn btn-outline-primary btn-sm mb-50 mb-sm-0"><i data-feather="plus"></i> Add New</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive-md">
                                            <form id="defectTypeForm" onsubmit="return false;">
                                                @csrf
                                                <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border newdesignerptable newdesignpomrnpad" id="defectTypeTable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Estimated Time (In Days) <span class="text-danger">*</span></th>
                                                            <th>Description</th>
                                                            <th>Action</th>
                                                        </tr>
                                                    </thead>
                                ...
                                <button id="floatingSubmitBtn" class="btn btn-primary" style="position: fixed; bottom: 30px; right: 30px; z-index:999; display:none"><i data-feather="check-circle"></i> Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
