...
class DefectNotificationController extends Controller
{
    ...
    {
        return view('defect-notification.index');
    }
    ...
    public function create()
    {
        ...
        return view('defect-notification.create', compact('series', 'items', 'locations','defectTypes','categories','equipments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($defectNotification->document_status !== 'draft') {
                ...
                $historyResult = Helper::documentAmendment($revisionData, $defectNotification->id);
                if (!$historyResult) {
                    Log::warning('Failed to create DefectNotificationHistory record during creation for ID: ' . $defectNotification->id);
                }
            }
    ...
    public function show(Request $request, string $id)
    {
        ...
        return view('defect-notification.show', compact(
            'series', 
            'items', 
            'defectNotification', 
            'buttons', 
    ...
    public function edit(string $id)
    {
        ...
        return view('defect-notification.edit', compact('defectNotification', 'series','buttons','approvalHistory','items', 'locations', 'defectTypes', 'equipments', 'categories'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            if ($defectNotification->document_status !== 'draft') {
                // Create DefectNotificationHistory record for submission
                $revisionData = [
                    [
                        "model_type" => "header",
                        "model_name" => "DefectNotification",
                ...
                $historyResult = Helper::documentAmendment($revisionData, $id);
                if (!$historyResult) {
                    Log::warning('Failed to create DefectNotificationHistory record during submission for ID: ' . $id);
                }
