                        ...
                        <div class="col-md-12 bg-light border-bottom mb-1 po-reportfileterBox">
                            <div class="row pofilterhead action-button align-items-center">
                                ...
                                <div
                                    ...
                                    <span> </span>
                                    <a class="btn btn-warning btn-sm mb-0 mx-1 waves-effect" href="/material-receipts/report">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="mb-1 mb-sm-0">
                                            ...
                                            <input type="text" class="form-control" id="lot_no" placeholder="Enter Lot No">
                                        </div>
                                    </div>
                                    <div class="col">
                    ...
                    <div class="tab-pane active" id="Employee">
                        <div class="compoenentboxreport">
                            ...
                            <div class="row sortable">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="gate-entry-no" checked="">
                                        <label class="form-check-label" for="gate-entry-no">Gate Entry No</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="lot-no" checked="">
                                        <label class="form-check-label" for="lot-no">LOT NO</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="accept-qty" checked="">
                                        <label class="form-check-label" for="accept-qty">Accepted Qty</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="rejected-qty" checked="">
                                        <label class="form-check-label" for="rejected-qty">Rejected Qty</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="pr-qty" checked="">
                                        <label class="form-check-label" for="pr-qty">Purchase Return Qty</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="pr-rejected-qty" checked="">
                                        <label class="form-check-label" for="pr-rejected-qty">Purchase Return Rejected Qty</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="purchase-bill-qty" checked="">
                                        <label class="form-check-label" for="purchase-bill-qty">Purchase Bill Qty</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="sub-store" checked="">
                                        <label class="form-check-label" for="sub-store">Store</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
...
<script src="{{ asset('assets/js/custom/mrn-report.js') }}"></script>
...
<script>
    window.routes = {
        poReport: @json(route('material-receipt.report.filter')),
        addScheduler: @json(route('material-receipt.add.scheduler')),
