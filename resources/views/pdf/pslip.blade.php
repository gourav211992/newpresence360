                        ...
                        <tr>
                            ...
                            <td style="width: 50%; vertical-align: top;">
                                <table style="width: 80%;" cellspacing="0" cellpadding="2">
                                    ...
                                    @if($order->sub_store?->name)
                                    <tr>
                                        <td><b>Sub Location:</b></td>
                                        <td>{{ $order?->sub_store?->name }}</td>
                                    </tr>
                                    @endif
                                    ...
                                    <tr>
                                        <td><b>Shift:</b></td>
                                        <td>{{ @$order->shift->label }}</td>
                                    </tr>
                                    @endif
                                    @if(!$order->is_last_station)
                                    <tr>
                                        <td><b>Type:</b></td>
