...
function initializeDataTable(selector, ajaxUrl, columns, filters = {}, exportTitle = 'Data', exportColumns = []) {
    var table = $(selector);
    if (table.length) {
        table.DataTable({
            processing: true,
            ...
            buttons: [
                {
                    ...
                    buttons: [
                        ...
                        { extend: 'pdf', text: feather.icons['clipboard'].toSvg({ class: 'font-small-4 mr-50' }) + ' PDF', className: 'dropdown-item', title: exportTitle, exportOptions: { columns: exportColumns }},
