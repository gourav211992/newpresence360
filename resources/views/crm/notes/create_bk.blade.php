                                ...
                                <div class="col-md-5">
                                    <div class="demo-inline-spacing">
                                        <div class="form-check form-check-primary mt-25">
                                            <input type="radio" id="customer_type1" name="customer_type" value="New"
                                                class="form-check-input" {{ Request::old('customer_type', 'New' )=='New'
                                                ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row loandetailview">
                                            <div class="col-md-6 mb-1">
                                                ...
                                                <input type="text" id="company_name" name="company_name" value="{{ Request::old('company_name') }}"
                                                    class="form-control @error('company_name') is-invalid @enderror" readonly/>
                                                @error('company_name')
                                            ...
                                            <div class="col-md-6 mb-1">
                                                ...
                                                <input type="text" id="phone_no" name="phone_no" value="{{ Request::old('phone_no') }}" class="form-control numberonly @error('phone_no') is-invalid @enderror" />
                                                @error('phone_no')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-6 mb-1">
                                                ...
                                                <input type="text" id="contact_person" name="contact_person"
                                                    class="form-control @error('contact_person') is-invalid @enderror" value="{{ Request::old('contact_person') }}" />
                                            ...
                                            <div class="col-md-12 mb-1">
                                                ...
                                                <input type="text" id="email_id" name="email_id" class="form-control @error('email_id') is-invalid @enderror" value="{{ Request::old('email_id') }}" />
                                                @error('email_id')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-12 mb-1">
                                                ...
                                                <input type="text" id="address" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ Request::old('address') }}"/>
                                                @error('address')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-12 mb-1 note" style="display: none">
                                                <label class="form-label" id="previous_note_label">Previous Note</label>
                                ...
                                <div class="col-md-12">
                                    <div class="m-2 p-2 rounded bg-white customernewsection-form">
                                        <div class="row align-items-center mb-1 stage" style="display: none">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control @error('meeting_status_id') is-invalid @enderror" name="meeting_status_id">
                                                    <option value="" disabled {{ Request::old('meeting_status_id') ? '' : 'selected'
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-6">
                                                <input type="hidden" name="meeting_objective" id="meeting_objective_input"/>
                                                <select class="form-control @error('meeting_objective') is-invalid @enderror" name="meeting_objective_id" id="meeting_objective_select">
                                                    <option value="" disabled {{ Request::old('meeting_objective_id') ? ''
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        $('#meeting_objective_select').on('change', function() {
            var selectedValue = $(this).find('option:selected').text().trim();  // Get the selected option's text
        ...
        function toggleCustomerFields() {
            ...
            if (selectedType === 'New') {
                ...
                if (customerIdSelect) {
                    console.log(customerIdSelect.value+"+++++++++"); // This will now only run if the element exists
    ...
    function fetchCustomers(customerId) {
        $.ajax({
            ...
            success: function (customer) {
                ...
                document.getElementById('sales_representative').value = customer['customer']['sales_representative'] ? customer['customer']['sales_representative']['name'] : '';
                ...
                if (customer['customer']['customer_address']) {
                    ...
                    document.getElementById('address_content').textContent = customer['customer']['customer_address'];
                }

                if (customer['diary']?.['subject']) {
                    document.getElementById('previous_note_content').hidden = false;
                    document.getElementById('previous_note_content').textContent = customer['diary']['subject'];
