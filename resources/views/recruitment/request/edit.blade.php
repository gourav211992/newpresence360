...
<div class="app-content content">
    ...
    <form class="form" role="post-data" method="POST" action="{{ url('recruitment/requests/'.$jobRequest->id) }}" redirect="{{ route('recruitment.requests') }}">
    @csrf
    @method('PUT')
        ...
        <div class="content-header pocreate-sticky">
            <div class="row">
                ...
                <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                    ...
                    <button class="btn btn-primary btn-sm mb-50 mb-sm-0" data-request="ajax-submit" data-target="[role=post-data]">
                            ...
                            <div class="card-body travelexp-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                            ...
                                            <div class="col-md-5 customernewsection-form">
                                                <div class="demo-inline-spacing">
                                                    <div class="form-check form-check-primary mt-25">
                                                        <input type="radio" id="New" name="job_type" value="new"
                                                            class="form-check-input job_type" {{ $jobRequest->job_type == 'new' ? 'checked' : '' }}/>
                                                        <label class="form-check-label fw-bolder" for="New">New</label>
                                                    </div>
                                                    <div class="form-check form-check-primary mt-25">
                                                        <input type="radio" id="Replacement" name="job_type"
                                                            value="replacement" class="form-check-input job_type" {{ $jobRequest->job_type == 'replacement' ? 'checked' : '' }} />
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-select select2" name="job_title_id">
                                                    <option value="" {{ $jobRequest->job_title_id ==  "" ? 'selected' : '' }}>Select</option>
                                                    @forelse ($jobTitles as $title)
                                                        <option value="{{ $title->id }}" {{ $jobRequest->job_title_id ==  $title->id ? 'selected' : '' }}>{{ $title->title }}</option>
                                                    @empty
                                                    @endforelse
                                                </select>
                                            </div>
                                        ...
                                        <div class="row align-items-center mb-1">
                                            <div class="col-md-3">
                                                <label class="form-label">No. of Position<span class="text-danger">*</span></label>
                                            </div>

                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="no_of_position" value="{{ $jobRequest->no_of_position }}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-select select2" name="education_id" value="{{ old('education_id') }}">
                                                    <option value="" {{ $jobRequest->education_id ==  "" ? 'selected' : '' }}>Select</option>
                                                    @forelse ($eduactions as $eduaction)
                                                        <option value="{{ $eduaction->id }}" {{ $jobRequest->education_id ==  $eduaction->id  ? 'selected' : '' }}>{{ $eduaction->name }}</option>
                                                    @empty
                                                    @endforelse
                                                </select>
                                            </div>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-select select2" name="certification_id" value="{{ old('certification_id') }}">
                                                    <option value="" {{ $jobRequest->certification_id ==  ""  ? 'selected' : '' }}>Select</option>
                                                    @forelse ($certifications as $certification)
                                                        <option value="{{ $certification->id }}" {{ $jobRequest->certification_id ==  $certification->id  ? 'selected' : '' }}>{{ $certification->name }}</option>
                                                    @empty
                                                    @endforelse
                                                </select>
                                            </div>
                                        ...
                                        <div class="row mb-1">
                                            <div class="col-md-3">
                                                <label class="form-label">Req. Skills<span class="text-danger">*</span></label>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-select select2" id="skill" name="skill[]" multiple>
                                                    ...
                                                    @foreach($skills as $skill)
                                                        <option value="{{$skill->name}}" {{ in_array($skill->id, $requestSkills) ? 'selected' : '' }}>{{ ucfirst($skill->name) }}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-1">
                                            <div class="col-md-3">
                                                <label class="form-label">Work Exp.<span class="text-danger">*</span></label>
                                            </div>

                                            <div class="col-md-5">
                                                <select class="form-control select2" id="work_exp_id" name="work_exp_id" >
                                                    <option value="" {{ $jobRequest->work_exp_id ==  ""  ? 'selected' : '' }}>Select Experience</option>
                                                    @foreach($workExperiences as $workExperience)
                                                        <option value="{{$workExperience->id}}" {{ $jobRequest->work_exp_id ==  $workExperience->id  ? 'selected' : '' }}>{{ ucfirst($workExperience->name) }}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-1">
                                            <div class="col-md-3">
                                                <label class="form-label">Expected D.O.J<span class="text-danger">*</span></label>
                                            </div>

                                            <div class="col-md-5">
                                                <input type="date" class="form-control" name="expected_doj" value="{{ $jobRequest->expected_doj }}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-select select2" name="priority">
                                                    <option value="" {{ $jobRequest->priority ==  "" ? 'selected' : '' }}>Select</option>
                                                    @forelse($priorities as $priority)
                                                        <option value="{{ $priority }}" {{ $jobRequest->priority ==  $priority ? 'selected' : '' }}>{{ $priority }}</option>
                                                    @empty
                                                    @endforelse
                                                </select>
                                            </div>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-control select2" id="location_id" name="location_id" >
                                                    <option value="" {{ $jobRequest->location_id ==  "" ? 'selected' : '' }}>Select Experience</option>
                                                    @foreach($locations as $location)
                                                        <option value="{{$location->id}}" {{ $jobRequest->location_id ==  $location->id ? 'selected' : '' }}>{{ ucfirst($location->store_name) }}</option>
                                                    @endforeach
                                                </select> 
                                            </div>
                                        </div>
