        ...
        <div class="content-wrapper container-xxl p-0">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                            href="{{route('finance.fixed-asset.registration.index')}}">Fixed Assets</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-body">
                <section id="basic-datatable">
                    <div class="row">
                        <form id="fixed-asset-depreciation-form" enctype="multipart/form-data">
                            @csrf
                            ...
                            <input type="hidden" name="grand_total_current_value_after_dep"
                                id="grand_total_current_value_after_dep" value="">
                            <input type="hidden" name="grand_total_dep_amount" id="grand_total_dep_amount" value="">
                            <input type="hidden" name="grand_total_after_dep_value" id="grand_total_after_dep_value"
                                value="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label for="period" class="form-label">Period <span
                                                                class="text-danger">*</span></label>
                                                    </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <select id="period" name="period" class="form-select" required>
                                                            ...
                                                            @if ($periodCollection->isNotEmpty())
                                                                <option value="{{ $periodCollection->first()->value }}">
                                                                    {{ $periodCollection->first()->label }}</option>
                                                            @endif
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" id="category_wise_detail">
                                                ...
                                                <div class="col-md-12 earn-dedtable">
                                                    <table
                                                        class="table table-striped po-order-detail custnewpo-detail border newdesignerptable newdesignpomrnpad">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>Category</th>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td id="grand_total_current_after_dep" class="text-end">
                                                                </td>
                                ...
                                if (asset.sub_asset && asset.sub_asset.length > 0) {
                                    asset.sub_asset.forEach((sub_asset, index) => {
                                        ...
                                        if (diffDays > 0) {
                                            ...
                                            //console.log(cutoffDate, capitalizeDate, capitalizeDate > cutoffDate);
                                            // October is month 9 (0-indexed)

                                            const [year, month, day] = sub_asset.capitalize_date.split('-').map(Number);
                                            const mmdd = month * 100 + day;

                                            // Half Year: Oct 4 (1004) to Dec 31 (1231) OR Jan 1 (101) to Mar 31 (331)
