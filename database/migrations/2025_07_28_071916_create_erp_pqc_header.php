...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_pqc_headers', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('selected_pq')->nullable();
            $table->unsignedBigInteger('selected_vendor')->nullable();
        ...
        Schema::create('erp_pqc_headers_history', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('erp_pqc_headers_history');
        Schema::dropIfExists('erp_pqc_headers');
    }
};
