...
class TDSReportController extends Controller
{
    ...
    public function exportTdsReport(Request $request)
    {
        ...
        // Example data array — you should replace this with your actual DB query result

        $organizationName = 'My Organization Pvt Ltd';
        $dateRange = $fy;

        return Excel::download(new TdsExport($data, $organizationName, $dateRange), 'TDS_Report.xlsx');
    }
}
