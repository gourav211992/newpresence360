...
return new class extends Migration
{
    public function up()
    {
        Schema::create('erp_finance_fixed_asset_revaluation_impairement', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('erp_finance_fixed_asset_revaluation_impairement');
    }
};
