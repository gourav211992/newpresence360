                    ...
                    <thead>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" id="new_exp_name_select" placeholder="Select"
                    ...
                    <table id="summaryExpTable"
                        ...
                        <tbody>
                            ...
                            <tr id="expSummaryFooter">
                                <td></td>
                                <td class="text-dark text-right"><strong>Totals</strong></td>
                                <td class="text-dark text-right"><strong
