                                        ...
                                        <table class="table table-striped myrequesttablecbox loanapplicationlist">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="fw-bolder text-dark">{{ $interview->date_time ? App\Helpers\CommonHelper::dateFormat($interview->date_time) : '' }}</span>
                                                        ({{ $interview->date_time ? App\Helpers\CommonHelper::timeFormat($interview->date_time) : '' }})</strong>
                                                        <br />
                                                        <a href="{{ $interview->meeting_link }}" class="d-flex align-items-center mt-25 font-small-2">
                                                            <i data-feather='video' class="me-25"></i> 
                                                            <strong>Join Meeting</strong>
                                                        </a>
                                                    </td>
                                                    <td class="fw-bolder text-dark">{{ isset($interview->job->job_id) ? $interview->job->job_id  : '' }}</td>
                                                    <td>
                                                        <a
                                                            ...
                                                            <span
                                                                ...
                                                                ucfirst($interview->job->status) }}</span>
                                                        </a>
                                                    </td>
                                                    <td>{{ isset($interview->job->job_title_name) ? $interview->job->job_title_name : '' }}</td>
                                                    <td>
                                                        <div class="d-flex flex-row">
                                                            <div style="background-color: #ddb6ff; color: #6b12b7; line-height: 30px; width: 30px; height: 30px; border-radius: 50%; position: relative; font-size: 1rem; text-align: center; margin-right: 5px; font-weight: 600;">                                                                    
                                                                {{ strtoupper(substr($interview->creator_name, 0, 1)) }}
                                                            </div>
                                                            <div class="my-auto">
                                                                <h6 class="mb-0 fw-bolder text-dark hr-dashemplname">{{ $interview->creator_name }}</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>{{ isset($interview->candidate->name) ? $interview->candidate->name : '' }}</td>
                                                    <td>{{ $interview->round_name ? $interview->round_name : '' }}</td>
                                                    <td>
                                                        @php
                                                    ...
                                                    <td class="tableactionnew">
                                                        <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <a class="dropdown-item" href="{{ route('recruitment.requests.job-view',['id' => $interview->job_id]) }}">
                                                                        <i data-feather="eye" class="me-50"></i>
                                                                        <span>View Detail</span>
                                                                    </a>
                                                                    @if(!$interview->interviewFeedback)
                                                                        <a class="dropdown-item" href="#feedbackcandidate" onclick="setFeedbackModal('{{ $interview->id }}')">
