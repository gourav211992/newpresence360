                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap">{{ $interview->date_time ? App\Helpers\CommonHelper::dateFormat($interview->date_time) : '' }}</td>
                                                    ...
                                                    <td class="tableactionnew">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item" href="{{ route('recruitment.jobs.show',['id' => $interview->job_id]) }}">
                                                                    <i data-feather="eye" class="me-50"></i>
                                                                    <span>View Detail</span>
                                                                </a> 
                                                                <a class="dropdown-item" href="javascript:;" data-bs-target="#status-modal" data-bs-toggle="modal" data-status="{{ App\Helpers\CommonHelper::CLOSED }}" data-title="Closed Job" data-id="{{ $interview->job_id }}">
...
<div class="modal fade" id="status-modal" tabindex="-1" aria-labelledby="statusModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form role="post-data" method="POST" id="status-form" action="" redirect="{{route('recruitment.jobs') }}">
                <div class="modal-body pb-2">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <button type="button" class="btn btn-primary" data-request="confirm-and-save" data-target="[role=post-data]">Submit</button>
                    </div>
            </form>
        </div>
    </div>
