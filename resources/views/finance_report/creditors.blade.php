...
@section('content')
                                        ...
                                        <div class="col-md-2">
                                            <div class="mt-2 mb-sm-0">
                                                ...
                                                <button class="btn mt-25 btn-warning btn-sm waves-effect waves-float waves-light" onClick="filter()">
                                                    <svg xmlns="https://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-filter"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon></svg> Run Report</button>
                                            </div>
    ...
    <form id="customExcelExportForm1"  action="{{ route('credit.debit.report.export') }}" method="POST">
        @csrf
        <input type="hidden" name="vendors" value="{{ json_encode($vendors) }}">
        ...
        <input type="hidden" name="ledger" value="{{ $selectedLedgerId}}">
    </form>
@endsection
@section('scripts')
