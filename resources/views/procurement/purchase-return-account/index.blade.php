                                                    ...
                                                    <tbody id="purchaseReturnAccountsTable">
                                                        @if($purchaseReturnAccounts->isEmpty())
                                                            <tr data-index="0" data-id="">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control mw-100 autocomplete category_name" name="purchase_return_accounts[0][category_name]" placeholder="Enter Category">
                                                                        <input type="hidden" name="purchase_return_accounts[0][category_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="purchase_return_accounts[0][sub_category_name]" placeholder="Enter Sub Category">
                                                        ...
                                                        @else
                                                            @foreach($purchaseReturnAccounts as $index => $item)
                                                                <tr data-index="{{ $index }}" data-id="{{ $item->id }}">
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <input type="text" class="form-control mw-100 autocomplete category_name" name="purchase_return_accounts[{{ $index }}][category_name]" value="{{ $item->category->name ?? '' }}" placeholder="Enter Category">
                                                                            <input type="hidden" name="purchase_return_accounts[{{ $index }}][category_id]" value="{{ $item->category_id ?? '' }}" />
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="purchase_return_accounts[{{ $index }}][sub_category_name]" value="{{ $item->subCategory->name ?? '' }}" placeholder="Enter Sub Category">
 ...
 document.addEventListener("DOMContentLoaded", function () {
    ...
    function addRow(clickedRow) {
        ...
        newRow.innerHTML = `
            ...
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control mw-100 autocomplete category_name" name="purchase_return_accounts[${rowIndex}][category_name]" placeholder="Enter Category">
                    <input type="hidden" name="purchase_return_accounts[${rowIndex}][category_id]" />
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="purchase_return_accounts[${rowIndex}][sub_category_name]" placeholder="Enter Sub Category">
