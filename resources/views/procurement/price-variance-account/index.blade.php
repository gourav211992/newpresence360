...
<style>
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper container-xxl p-0">
            <form class="ajax-input-form" method="POST" action="{{ route('price-variance-accounts.store') }}" data-redirect="{{ url('/price-variance-accounts') }}" id="priceVarianceAccountForm">
            @csrf
                ...
                <div class="row">
                    <div class="content-header-left col-md-6 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Price Variance Account Setup</h2>
                                        ...
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border newdesignerptable newdesignpomrnpad">
                                                    ...
                                                    <tbody id="priceVarianceAccountsTable">
                                                        @if($priceVarianceAccounts->isEmpty())
                                                            <tr data-index="0" data-id="">
                                                                <td>1</td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2" name="price_variance_accounts[0][company_id]">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2" name="price_variance_accounts[0][organization_id]">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control mw-100 autocomplete category_name" name="price_variance_accounts[0][category_name]" placeholder="Enter Category">
                                                                        <input type="hidden" name="price_variance_accounts[0][category_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="price_variance_accounts[0][sub_category_name]" placeholder="Enter Sub Category">
                                                                        <input type="hidden" name="price_variance_accounts[0][sub_category_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 item-select" name="price_variance_accounts[0][item_id][]" multiple>
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2" name="price_variance_accounts[0][book_id][]" multiple>
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control mw-100 autocomplete ledger_name" name="price_variance_accounts[0][ledger_name]" placeholder="Enter Ledger">
                                                                        <input type="hidden" name="price_variance_accounts[0][ledger_id]" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <select class="form-select select2 ledger_group_name" name="price_variance_accounts[0][ledger_group_id]" placeholder="Select Ledger Group">
                                                                        </select>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                        ...
                                                        @else
                                                            @foreach($priceVarianceAccounts as $index => $item)
                                                                <tr data-index="{{ $index }}" data-id="{{ $item->id }}">
                                                                    <td>{{ $index + 1 }}</td>
                                                                    <input type="hidden" name="price_variance_accounts[{{ $index }}][id]" value="{{ $item->id }}">
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2 company-select" name="price_variance_accounts[{{ $index }}][company_id]" data-row="{{ $index }}">
                                                                                <option value="">Select Company</option>
                                                                                @foreach($companies as $company)
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2 organization-select" name="price_variance_accounts[{{ $index }}][organization_id]" data-row="{{ $index }}">
                                                                                <option value="">Select Organization</option>
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <input type="text" class="form-control mw-100 autocomplete category_name" name="price_variance_accounts[{{ $index }}][category_name]" value="{{ $item->category->name ?? '' }}" placeholder="Enter Category">
                                                                            <input type="hidden" name="price_variance_accounts[{{ $index }}][category_id]" value="{{ $item->category_id ?? '' }}" />
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="price_variance_accounts[{{ $index }}][sub_category_name]" value="{{ $item->subCategory->name ?? '' }}" placeholder="Enter Sub Category">
                                                                            <input type="hidden" name="price_variance_accounts[{{ $index }}][sub_category_id]" value="{{ $item->sub_category_id ?? '' }}" />
                                                                        </div>
                                                                    </td>
                                                                    <td> 
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2 item-select " name="price_variance_accounts[{{ $index }}][item_id][]" multiple>
                                                                                @php 
                                                                                ...
                                                                                @elseif($categoryId && $item->category && $item->category->items->where('status', '!=', 'draft'))
                                                                                    @foreach($item->category->items->where('status', '!=', 'draft') as $itemOption)  {{-- Excluding drafts --}}
                                                                                        @if(!$organizationId || $itemOption->organization_id == $organizationId)  {{-- Check for organization filter --}}
                                                                                            <option value="{{ $itemOption->id }}" data-item-code="{{ $itemOption->item_code }}" {{ in_array($itemOption->id, $itemIds) ? 'selected' : '' }}>
                                                                                                {{ $itemOption->item_name }} ({{ $itemOption->item_code }})
                                                                                            </option>
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2 book-select" name="price_variance_accounts[{{ $index }}][book_id][]" multiple data-row="{{ $index }}">
                                                                                <option value="">Select Book</option>
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <input type="text" class="form-control mw-100 autocomplete ledger_name" name="price_variance_accounts[{{ $index }}][ledger_name]" value="{{ $item->ledger->name ?? '' }}" placeholder="Enter Ledger">
                                                                            <input type="hidden" name="price_variance_accounts[{{ $index }}][ledger_id]" value="{{ $item->ledger_id ?? '' }}" />
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <select class="form-select select2 ledger_group_name" name="price_variance_accounts[{{ $index }}][ledger_group_id]" placeholder="Select Ledger Group">
                                                                                @if($item->ledger) 
 ...
 document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector('tbody').addEventListener('click', function (e) {
        ...
        if (e.target.closest('.delete-row')) {
            e.preventDefault();
            const row = e.target.closest('tr');
            const priceVarianceAccountId = row.dataset.id;  
            if (priceVarianceAccountId) {
                Swal.fire({
                    title: 'Are you sure?',
                    ...
                    if (result.isConfirmed) {
                        fetch(`/price-variance-accounts/${priceVarianceAccountId}`, {  
                            method: 'DELETE',
                            headers: {
                        ...
                        .then(response => {
                            if (response.status) {
                                ...
                                Swal.fire('Error!', response.message || 'Could not delete Price Variance account.', 'error');
                            }
                        })
                        .catch(() => {
                            Swal.fire('Error!', 'An error occurred while deleting the Price Variance account.', 'error');
                        });
                    }
                });
            } else {
   ...
   function addRow(clickedRow) {
        const tableBody = document.querySelector('#priceVarianceAccountsTable');
        ...
        newRow.innerHTML = `
            ...
            <td> 
                <div class="setup-td-width">
                    <select class="form-select select2" name="price_variance_accounts[${rowIndex}][company_id]">
                        <option value="">Select Company</option>
                        @foreach($companies as $company)
                            <option value="{{ $company->id }}">{{ $company->name }}</option>
                        @endforeach
            ...
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2" name="price_variance_accounts[${rowIndex}][organization_id]"> 
                        <option value="">Select Organization</option>
                    </select>
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control mw-100 autocomplete category_name" name="price_variance_accounts[${rowIndex}][category_name]" placeholder="Enter Category">
                    <input type="hidden" name="price_variance_accounts[${rowIndex}][category_id]" />
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="price_variance_accounts[${rowIndex}][sub_category_name]" placeholder="Enter Sub Category">
                    <input type="hidden" name="price_variance_accounts[${rowIndex}][sub_category_id]" />
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2 item-select" name="price_variance_accounts[${rowIndex}][item_id][]" multiple> 
                        <option value="">Select Item</option>
                    </select>
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2" name="price_variance_accounts[${rowIndex}][book_id][]" multiple> 
                        <option value="">Select Book</option>
                    </select>
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control mw-100 autocomplete ledger_name" name="price_variance_accounts[${rowIndex}][ledger_name]" placeholder="Enter Ledger">
                    <input type="hidden" name="price_variance_accounts[${rowIndex}][ledger_id]" />
                </div>
            </td>
            <td>
                <div class="setup-td-width">
                    <select class="form-select select2 ledger_group_name" name="price_variance_accounts[${rowIndex}][ledger_group_id]" placeholder="Select Ledger Group">
                    </select>
                </div>
            </td>
            <td>
    ...
    updateRowIndexes();
    $(document).on('change', '[name^="price_variance_accounts"][name$="[company_id]"]', function () {
