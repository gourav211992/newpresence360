        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-sm-end col-md-7">
                <div class="form-group d-flex flex-wrap align-items-center justify-content-sm-end mb-sm-0 mb-1">
                    ...
                    <a href="{{ route('prospects.dashboard') }}"><button class="btn btn-warning box-shadow-2 btn-sm me-1 mb-sm-0 mb-sm-50"><i
                            data-feather="refresh-cw"></i> Clear</button></a>
                    <a href="{{ route('prospects.index') }}" class="btn btn-dark box-shadow-2 btn-sm me-1 mb-sm-0 mb-sm-50"><i
                            data-feather="file-text"></i> View All</a>
                    <a href="{{ route('prospects.index',['status' => App\Helpers\ConstantHelper::WON]) }}" class="btn btn-primary box-shadow-2 btn-sm mb-sm-0 mb-sm-50"><i
                            data-feather="users"></i> Won Customers</a>
                </div>
            </div>
        </div>
                                    ...
                                    <div>
                                        <div class="avatar bg-light-info">
                                            <div class="avatar-content">
                                                <i data-feather="{{ $value->icon ? $value->icon : 'dollar-sign' }}" class="avatar-icon" style="color: {{ $value->color_code }};"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-4">
                                                    <div class="row mt-sm-2">
                                                        ...
                                                        <div class="col-md-9 col-10">
                                                            <h2 class="fw-bolder text-primary">{{ $prospectsData['limit'] }}</h2>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-md-9 col-10">
                                                            <h2 class="fw-bolder text-success">{{ $prospectsData['salesFigureSum'] ? App\Helpers\Helper::currencyFormat($prospectsData['salesFigureSum'],'display') : 0 }}</h2>
                                    ...
                                    <div class="col-md-12 ">
                                        <table class="table border payrollconfigured customerdataapp">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-dark fw-bolder"><strong>{{isset($value->company_name) ? $value->company_name : '-'}}</strong></td>
                                                    <td><span
                                        ...
                                        @forelse($prospectsData['statusData'] as $key => $value)
                                            ...
                                            <div class="d-flex justify-content-between mt-2 mb-1">
                                                <div class="d-flex align-items-center">
                                                    <i data-feather="check-circle" class="font-medium-2" style="color:{{ $value->color_code }}"></i>
                                                    <span class="fw-bold ms-75 me-25">{{ $value->title }}</span>
                                                </div>
                                                <div>
                                                    <span class="badge rounded-pill" style="color:{{ $value->color_code }};background-color:rgba(115, 103, 240, 0.12);">{{ $value->prospects_count }}</span>
                                                </div>
                                            </div>
                                            @endif
                                        @empty
                    ...
                    <div class="col-md-6">
                        <div class="card overtimechart">
                            <div class="card-header newheader d-flex justify-content-between align-items-start">
                                ...
                                <div class="dropdown d-flex align-items-center">
                                    <p class="mb-0 text-end font-small-2 me-1"><a class="mb-0 text-primary"
                                            href="{{ route('prospects.index',['status' => App\Helpers\ConstantHelper::LOST]) }}"><i data-feather='eye'></i> View All</a></p>
                                </div>
                            </div>
                            <div class="card-body">
